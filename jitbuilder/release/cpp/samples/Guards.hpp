...
class GuardMethod : public OMR::JitBuilder::MethodBuilder
   {
   public:
   GuardMethod(OMR::JitBuilder::TypeDictionary *types);
   virtual bool buildIL();
   uint32_t assumption() { return _assumption; }

   private:
   uint32_t _assumption;
   };
