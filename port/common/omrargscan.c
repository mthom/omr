 ...
 */
char * trim(OMRPortLibrary *portLibrary, char * input)
{
...
char *scan_to_delim(OMRPortLibrary *portLibrary, char **scan_start, char delimiter)
{
 ...
 */
void scan_failed(OMRPortLibrary * portLibrary, const char* module, const char *scan_start)
{
 ...
 * Print an error message indicating that an option was not recognized
 */
void scan_failed_incompatible(OMRPortLibrary * portLibrary, char* module, char *scan_start)
{
 ...
 * Print an error message indicating that an option was not recognized
 */
void scan_failed_unsupported(OMRPortLibrary * portLibrary, char* module, char *scan_start)
{
