...
#define OMRPORT_ERROR_STARTUP_EXTENDED -500
#define OMRPORT_ERROR_STARTUP_IPCMUTEX (OMRPORT_ERROR_STARTUP_EXTENDED)
#define OMRPORT_ERROR_STARTUP_SOCK (OMRPORT_ERROR_STARTUP_EXTENDED -1)
#define OMRPORT_ERROR_STARTUP_GP (OMRPORT_ERROR_STARTUP_EXTENDED -2)
#define OMRPORT_ERROR_STARTUP_SHSEM (OMRPORT_ERROR_STARTUP_EXTENDED -3)
#define OMRPORT_ERROR_STARTUP_SHMEM (OMRPORT_ERROR_STARTUP_EXTENDED -4)
#define OMRPORT_ERROR_STARTUP_SHMEM_MOSERVICE (OMRPORT_ERROR_STARTUP_EXTENDED -5)
