 ...
 */
BOOLEAN
simplepool_checkConsistency(J9SimplePool *simplePool, OMRPortLibrary *portLib, BOOLEAN (*doFunction) (void *anElement, void *userData), void *userData, uintptr_t skipCount);
/**
 * @brief
 * @param void
 * @return uintptr_t
