...
static BOOLEAN iterateOverSimplePoolElements(J9SimplePool* simplePool, OMRPortLibrary *portLib, BOOLEAN (*doFunction) (void* anElement, void* userData), void* userData, UDATA skipCount);
 ...
 * @param[in] portLib		A pointer to the port library, (this is required for omrmem_allocate/free functions)
 ...
 */
BOOLEAN
simplepool_do(J9SimplePool* simplePool, OMRPortLibrary *portLib, BOOLEAN (*doFunction) (void* anElement, void* userData), void* userData)
{
	BOOLEAN rc = TRUE;
 ...
 */
static BOOLEAN
iterateOverSimplePoolElements(J9SimplePool* simplePool, OMRPortLibrary *portLib, BOOLEAN (*doFunction) (void* anElement, void* userData), void* userData, UDATA skipCount)
{
	BOOLEAN rc = TRUE;
	U_8* allocMap = NULL;
	U_32 allocMapSize = 0;
	...
	allocMap = omrmem_allocate_memory(allocMapSize, OMRMEM_CATEGORY_VM);
 ...
 */
BOOLEAN
simplepool_checkConsistency(J9SimplePool* simplePool, OMRPortLibrary *portLib, BOOLEAN (*doFunction) (void* anElement, void* userData), void* userData, UDATA skipCount)
{
	BOOLEAN rc = TRUE;
