...
public:
	...
	static SH_AttachedDataManagerImpl* newInstance(OMR_VM* vm, SH_SharedCache* cache, SH_AttachedDataManagerImpl* memForConstructor);
...
private:
	UDATA _numBytesByType[OMRSHR_ATTACHED_DATA_TYPE_MAX+1];
	UDATA _bytesByType[OMRSHR_ATTACHED_DATA_TYPE_MAX+1];
