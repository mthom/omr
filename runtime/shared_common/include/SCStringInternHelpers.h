...
sharedInternHashEqualFn(void *existingEntry, void *key, void *userData)
{
	...
	return OMRUTF8_DATA_EQUALS(existingUtf8Data, existingUtf8Length, keyUtf8Data, keyUtf8Length);
}

/**
 * Calculates the hash value for the given key and userData
 * @param key Either it is OMRUTF8 * or J9SharedInternHashTableQuery * which has the utf8 data and length in it.
 * @param userData
