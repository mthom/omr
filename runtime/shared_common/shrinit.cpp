...
#define SHRINIT_TRACE(verbose, var) if (verbose) omrnls_printf(J9NLS_INFO, var)
#define SHRINIT_TRACE1(verbose, var, p1) if (verbose) omrnls_printf(J9NLS_INFO, var, p1)
#define SHRINIT_TRACE2(verbose, var, p1, p2) if (verbose) omrnls_printf(J9NLS_INFO, var, p1, p2)
#define SHRINIT_TRACE3(verbose, var, p1, p2, p3) if (verbose) omrnls_printf(J9NLS_INFO, var, p1, p2, p3)
#define SHRINIT_TRACE_NOTAG(verbose, var) if (verbose) omrnls_printf(J9NLS_DO_NOT_PRINT_MESSAGE_TAG, var)
#define SHRINIT_TRACE1_NOTAG(verbose, var, p1) if (verbose) omrnls_printf(J9NLS_DO_NOT_PRINT_MESSAGE_TAG, var, p1)
#define SHRINIT_TRACE2_NOTAG(verbose, var, p1, p2) if (verbose) omrnls_printf(J9NLS_DO_NOT_PRINT_MESSAGE_TAG, var, p1, p2)
#define SHRINIT_TRACE3_NOTAG(verbose, var, p1, p2, p3) if (verbose) omrnls_printf(J9NLS_DO_NOT_PRINT_MESSAGE_TAG, var, p1, p2, p3)
#define SHRINIT_TRACE4_NOTAG(verbose, var, p1, p2, p3, p4) if (verbose) omrnls_printf(J9NLS_DO_NOT_PRINT_MESSAGE_TAG, var, p1, p2, p3, p4)
#define SHRINIT_INFO_TRACE(verbose, var) if (verbose) omrnls_printf(J9NLS_INFO, var)
#define SHRINIT_ERR_TRACE(verbose, var) if (verbose) omrnls_printf(J9NLS_ERROR, var)
#define SHRINIT_ERR_TRACE1(verbose, var, p1) if (verbose) omrnls_printf(J9NLS_ERROR, var, p1)
#define SHRINIT_ERR_TRACE2(verbose, var, p1, p2) if (verbose) omrnls_printf(J9NLS_ERROR, var, p1, p2)
#define SHRINIT_ERR_TRACE3(verbose, var, p1, p2, p3) if (verbose) omrnls_printf(J9NLS_ERROR, var, p1, p2, p3)
#define SHRINIT_WARNING_TRACE(verbose, var) if (verbose) omrnls_printf(J9NLS_WARNING, var)
#define SHRINIT_WARNING_TRACE1(verbose, var, p1) if (verbose) omrnls_printf(J9NLS_WARNING, var, p1)
#define SHRINIT_WARNING_TRACE2(verbose, var, p1, p2) if (verbose) omrnls_printf(J9NLS_WARNING, var, p1, p2)
#define SHRINIT_WARNING_TRACE3(verbose, var, p1, p2, p3) if (verbose) omrnls_printf(J9NLS_WARNING, var, p1, p2, p3)
...
J9SharedClassesOptions J9SHAREDCLASSESOPTIONS[] = {
	...
	{ OPTION_PRINTDETAILS, PARSE_TYPE_EXACT, RESULT_DO_PRINTDETAILS, OMRSHR_RUNTIMEFLAG_ENABLE_DETAILED_STATS},
	...
	{ OPTION_NO_TIMESTAMP_CHECKS, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_TIMESTAMP_CHECKS},
	{ OPTION_NO_CLASSPATH_CACHEING, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_LOCAL_CACHEING},
	{ OPTION_NO_REDUCE_STORE_CONTENTION, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_REDUCE_STORE_CONTENTION}, 
	{ OPTION_VERBOSE, PARSE_TYPE_EXACT, RESULT_DO_ADD_VERBOSEFLAG, OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE},
	{ OPTION_VERBOSE_IO, PARSE_TYPE_EXACT, RESULT_DO_ADD_VERBOSEFLAG, OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE_IO},
	{ OPTION_VERBOSE_HELPER, PARSE_TYPE_EXACT, RESULT_DO_ADD_VERBOSEFLAG, OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE_HELPER},
	{ OPTION_VERBOSE_AOT, PARSE_TYPE_EXACT, RESULT_DO_ADD_VERBOSEFLAG, OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE_AOT},
	{ OPTION_VERBOSE_JITDATA, PARSE_TYPE_EXACT, RESULT_DO_ADD_VERBOSEFLAG, OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE_JITDATA},
	{ OPTION_MODIFIED_EQUALS, PARSE_TYPE_STARTSWITH, RESULT_DO_MODIFIED_EQUALS, 0},
	{ OPTION_NO_BYTECODEFIX, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_BYTECODEFIX},
	{ OPTION_TRACECOUNT, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_TRACECOUNT},
	{ OPTION_GROUP_ACCESS, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_GROUP_ACCESS},
	...
	{ OPTION_NONFATAL, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_NONFATAL},
	{ OPTION_FATAL, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_NONFATAL},
	{ OPTION_CONTROLDIR_EQUALS, PARSE_TYPE_STARTSWITH, RESULT_DO_CTRLD_EQUALS, 0},
	{ OPTION_NOAOT, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_AOT},
	{ OPTION_NO_JITDATA, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_JITDATA},
	{ OPTION_VERBOSE_INTERN, PARSE_TYPE_EXACT, RESULT_DO_ADD_VERBOSEFLAG, OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE_INTERN},
	{ OPTION_VERBOSE_PAGES, PARSE_TYPE_EXACT, RESULT_DO_ADD_VERBOSEFLAG, OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE_PAGES},
	{ OPTION_NO_ROUND_PAGES, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_ROUND_TO_PAGE_SIZE},
	{ OPTION_MPROTECT_EQUALS, PARSE_TYPE_STARTSWITH, RESULT_DO_MPROTECT_EQUALS, 0},
	{ OPTION_CACHERETRANSFORMED, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_CACHERETRANSFORMED},
	{ OPTION_NOBOOTCLASSPATH, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_CACHEBOOTCLASSES},
	{ OPTION_BOOTCLASSESONLY, PARSE_TYPE_EXACT, RESULT_DO_BOOTCLASSESONLY, OMRSHR_RUNTIMEFLAG_ENABLE_CACHE_NON_BOOT_CLASSES},
	{ OPTION_VERBOSE_DATA, PARSE_TYPE_EXACT, RESULT_DO_ADD_VERBOSEFLAG, OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE_DATA},
	...
	{ OPTION_READONLY, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_READONLY},
	{ OPTION_PERSISTENT, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_PERSISTENT_CACHE | OMRSHR_RUNTIMEFLAG_PERSISTENT_KEYWORD},
	{ OPTION_NONPERSISTENT, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_PERSISTENT_CACHE},
	{ OPTION_NO_AUTOPUNT, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_AUTOKILL_DIFF_BUILDID},
	{ OPTION_NO_DETECT_NETWORK_CACHE, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_DETECT_NETWORK_CACHE},
#if !defined(WIN32)
	{ OPTION_SNAPSHOTCACHE, PARSE_TYPE_EXACT, RESULT_DO_SNAPSHOTCACHE, OMRSHR_RUNTIMEFLAG_SNAPSHOT},
	...
	{ OPTION_RESTORE_FROM_SNAPSHOT, PARSE_TYPE_EXACT, RESULT_DO_RESTORE_FROM_SNAPSHOT, OMRSHR_RUNTIMEFLAG_RESTORE},
	{ OPTION_PRINT_SNAPSHOTNAME, PARSE_TYPE_EXACT, RESULT_DO_PRINT_SNAPSHOTNAME, 0},
#endif /* !defined(WIN32) */
#if defined(OMRSHR_CACHELET_SUPPORT)
	{ OPTION_NESTED, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_NESTED},
#endif
	...
	{ OPTION_NO_SEMAPHORE_CHECK, PARSE_TYPE_EXACT, RESULT_DO_REMOVE_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_SEMAPHORE_CHECK},
	{ OPTION_VERIFY_TREE, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_VERIFY_TREE_AND_TREE_ACCESS },
	{ OPTION_CHECK_STRING_TABLE, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_STRING_TABLE_CHECK},
	{ OPTION_TEST_BAD_BUILDID, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ENABLE_TEST_BAD_BUILDID},
	{ OPTION_FORCE_DUMP_IF_CORRUPT, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_FORCE_DUMP_IF_CORRUPT},
	{ OPTION_FAKE_CORRUPTION, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_FAKE_CORRUPTION},
	{ OPTION_DO_EXTRA_AREA_CHECKS, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_DBG_EXTRA_CHECKS},
	{ OPTION_CREATE_OLD_GEN, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_CREATE_OLD_GEN},
	{ OPTION_DISABLE_CORRUPT_CACHE_DUMPS, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_DISABLE_CORRUPT_CACHE_DUMPS},
	{ OPTION_CACHEDIRPERM_EQUALS, PARSE_TYPE_STARTSWITH, RESULT_DO_CACHEDIRPERM_EQUALS, 0},
	{ OPTION_CHECK_STRINGTABLE_RESET, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_CHECK_STRINGTABLE_RESET_READONLY | OMRSHR_RUNTIMEFLAG_CHECK_STRINGTABLE_RESET_READWRITE},
	{ OPTION_ENABLE_BCI, PARSE_TYPE_EXACT, RESULT_DO_ENABLE_BCI, OMRSHR_RUNTIMEFLAG_ENABLE_BCI },
	{ OPTION_DISABLE_BCI, PARSE_TYPE_EXACT, RESULT_DO_DISABLE_BCI, OMRSHR_RUNTIMEFLAG_DISABLE_BCI },
	...
	{ OPTION_ADDTESTJITHINT, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ADD_TEST_JITHINT},
	{ OPTION_STORAGE_KEY_EQUALS, PARSE_TYPE_STARTSWITH, RESULT_DO_ADD_STORAGE_KEY_EQUALS, 0},
	{ OPTION_RESTRICT_CLASSPATHS, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_RESTRICT_CLASSPATHS },
	{ OPTION_ALLOW_CLASSPATHS, PARSE_TYPE_EXACT, RESULT_DO_ADD_RUNTIMEFLAG, OMRSHR_RUNTIMEFLAG_ALLOW_CLASSPATHS },
	{ OPTION_INVALIDATE_AOT_METHODS_EQUALS, PARSE_TYPE_STARTSWITH, RESULT_DO_INVALIDATE_AOT_METHODS_EQUALS, OMRSHR_RUNTIMEFLAG_DO_NOT_CREATE_CACHE},
	{ OPTION_REVALIDATE_AOT_METHODS_EQUALS, PARSE_TYPE_STARTSWITH, RESULT_DO_REVALIDATE_AOT_METHODS_EQUALS, OMRSHR_RUNTIMEFLAG_DO_NOT_CREATE_CACHE},
...
bool modifyCacheName(OMR_VM *vm, const char* origName, UDATA verboseFlags, char** modifiedCacheName, UDATA bufLen);
static BOOLEAN omrshr_parseMemSize(char * str, UDATA & value);
static void addTestJitHint(J9HookInterface** hookInterface, UDATA eventNum, void* voidData, void* userData);
static IDATA omrshr_restoreFromSnapshot(OMR_VM* vm, const char* ctrlDirName, const char* cacheName, bool* cacheExist);
...
static bool isFreeDiskSpaceLow(OMR_VM *vm, U_64* maxsize);
...
//void 
//omrshr_hookZipLoadEvent(J9HookInterface** hook, UDATA eventNum, void* eventData, void* userData)
//{
//	J9VMZipLoadEvent* event = (J9VMZipLoadEvent*)eventData;
//	char* filename = (char*)event->cpPath;
//	UDATA state = event->newState; 
//	OMR_VM* vm = (OMR_VM*)event->userData;
//	J9VMThread* currentThread = vm->internalVMFunctions->currentVMThread(vm);
//	U_64 localRuntimeFlags = vm->sharedClassConfig->runtimeFlags;
//	
//	if (!(localRuntimeFlags & OMRSHR_RUNTIMEFLAG_CACHE_INITIALIZATION_COMPLETE) ||
//		(localRuntimeFlags & OMRSHR_RUNTIMEFLAG_DENY_CACHE_ACCESS)
//	   )
//	{
//		return;
//	}
...
IDATA 
omrshr_print_stats(OMR_VM *vm, UDATA parseResult, U_64 runtimeFlags, UDATA printStatsOptions);

static void 
omrshr_print_cache_filename(OMR_VM* vm, const char* cacheDirName, U_64 runtimeFlags, const char* cacheName);

static void
reportUtilityNotApplicable(OMR_VM* vm, const char* ctrlDirName, const char* cacheName, UDATA verboseFlags, U_64 runtimeFlags, UDATA command);

static void 
printRuntimeFlags (OMRPortLibrary* portLibrary, U_64 runtimeFlags, UDATA verboseFlags)
{
	OMRPORT_ACCESS_FROM_OMRPORT(portLibrary);

	if (verboseFlags & OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE) {
		if (!(runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_TIMESTAMP_CHECKS)) {
			SHRINIT_TRACE(verboseFlags, J9NLS_SHRC_SHRINIT_TIMESTAMP_DISABLED_INFO);
		} 

		if (!(runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_LOCAL_CACHEING)) {
			SHRINIT_TRACE(verboseFlags, J9NLS_SHRC_SHRINIT_CPCACHEING_DISABLED_INFO);
		}

		if (!(runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_REDUCE_STORE_CONTENTION)) {
			SHRINIT_TRACE(verboseFlags, J9NLS_SHRC_SHRINIT_STCONT_REDUCE_DISABLED_INFO);
		}
	
		if ((runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_GROUP_ACCESS)) {
			SHRINIT_TRACE_NOTAG(verboseFlags, J9NLS_SHRC_SHRINIT_GROUP_ACCESS_INFO);
		}
			if ((runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_PERSISTENT_CACHE)) {
		...
		if ((runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_CACHERETRANSFORMED)) {
			SHRINIT_TRACE_NOTAG(verboseFlags, J9NLS_SHRC_SHRINIT_CACHERETRANSFORMED_INFO);
		}
		
		if (!(runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_CACHEBOOTCLASSES)) {
...
//
//UDATA
//parseArgs(OMR_VM* vm, char* options, U_64* runtimeFlags, UDATA* verboseFlags, char** cacheName,
...
//				*runtimeFlags |= OMRSHR_RUNTIMEFLAG_CACHEDIR_PRESENT;
//			}
...
//			BOOLEAN parseAreaSize = omrshr_parseMemSize(areasize, tmpareasize);
//
//			if (FALSE == parseAreaSize) {
//				SHRINIT_ERR_TRACE1(1, J9NLS_SHRC_SHRINIT_OPTION_INVALID_MEMORY_SIZE, options);
//				return RESULT_PARSE_FAILED;
//			}
//			if (OMR_ARE_ALL_BITS_SET(*runtimeFlags, OMRSHR_RUNTIMEFLAG_ENABLE_READONLY)) {
//				*runtimeFlags &= ~OMRSHR_RUNTIMEFLAG_ENABLE_READONLY;
...
//			*runtimeFlags |= OMRSHR_RUNTIMEFLAG_DO_NOT_CREATE_CACHE;
//			continue;
//		}
//
//		case RESULT_DO_EXPIRE:
//			if (OMR_ARE_ALL_BITS_SET(*runtimeFlags, OMRSHR_RUNTIMEFLAG_SNAPSHOT)) {
//				/* ignore "snapshotCache" if it is specified before expire option */
//				*runtimeFlags &= ~OMRSHR_RUNTIMEFLAG_SNAPSHOT;
//			}
...
//				*runtimeFlags &= ~(OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT
//								| OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_ALL
//								| OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_RW
//								| OMRSHR_RUNTIMEFLAG_MPROTECT_PARTIAL_PAGES_ON_STARTUP
//								| OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_PARTIAL_PAGES
//								| OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_ONFIND);
...
//				*runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT;
//#else
//				*runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_RW | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_PARTIAL_PAGES;
//#endif /* defined(J9ZOS390) || defined(AIXPPC) */
//				*runtimeFlags &= ~(OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_ONFIND | OMRSHR_RUNTIMEFLAG_MPROTECT_PARTIAL_PAGES_ON_STARTUP);
//				tempInt = strlen(SUB_OPTION_MPROTECT_DEF);
//			} else if (0 == strcmp(tempStr, SUB_OPTION_MPROTECT_ONFIND)) {
//				/* When enabling mprotect=onfind, ensure flags for mprotect=default along with OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_PARTIAL_PAGES are also set */
//#if defined(J9ZOS390) || defined(AIXPPC)
//				/* Calling mprotect on the RW when using persistent caches on AIX and ZOS
//				 *  has a severe performance impact on class loading (approx ~20% slower)
//				 */
//				*runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_PARTIAL_PAGES;
//#else
//				*runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_RW | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_PARTIAL_PAGES;
//#endif /* defined(J9ZOS390) || defined(AIXPPC) */
//				*runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_ONFIND;
...
//				*runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_RW | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_PARTIAL_PAGES;
//#endif /* defined(J9ZOS390) || defined(AIXPPC) */
//				*runtimeFlags |= OMRSHR_RUNTIMEFLAG_MPROTECT_PARTIAL_PAGES_ON_STARTUP;
...
//				 */
//#if defined(J9ZOS390)
//				/* Moreover, on z/OS partial page protection needs to be enabled since JVM startup (which is flag OMRSHR_RUNTIMEFLAG_MPROTECT_PARTIAL_PAGES_ON_STARTUP),
...
//				 */
//				*runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_PARTIAL_PAGES | OMRSHR_RUNTIMEFLAG_MPROTECT_PARTIAL_PAGES_ON_STARTUP;
//#elif defined(AIXPPC)
//				*runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_PARTIAL_PAGES;
//#else
//				*runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_RW | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_PARTIAL_PAGES;
...
//				if ((*runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_ALL) == 0) {
//					*runtimeFlags &= ~OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_RW;
//				}
//				*runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT;
//				tempInt = strlen(SUB_OPTION_MPROTECT_NO_RW);
//			} else if (0 == strcmp(tempStr, SUB_OPTION_MPROTECT_NO_PARTIAL_PAGES)) {
//				*runtimeFlags &= ~(OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_PARTIAL_PAGES | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_ONFIND);
...
//
//			char delim = '+';
//			char  * filter = (char*)omrmem_allocate_memory(strlen(tempStr)+1, J9MEM_CATEGORY_CLASSES);
//			if (NULL == filter) {
...
//		        	 *runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_DETAILED_STATS;
...
//		        	 }
//
//					omrmem_free_memory(filterOriginal);
//					return RESULT_PARSE_FAILED;
//		         }
//		         if (hasMoreToken) {
...
//			if (J9_ARE_NO_BITS_SET(*runtimeFlags, OMRSHR_RUNTIMEFLAG_SNAPSHOT)) {
//				returnAction = J9SHAREDCLASSESOPTIONS[i].action;
//#if !defined(WIN32)
//			} else {
...
//			*runtimeFlags |= J9SHAREDCLASSESOPTIONS[i].flag;
//			/* Clear OMRSHR_RUNTIMEFLAG_DISABLE_BCI in case it was set earlier */
//			*runtimeFlags &= (~OMRSHR_RUNTIMEFLAG_DISABLE_BCI);
//			break;
//
//		case RESULT_DO_DISABLE_BCI:
//			*runtimeFlags |= J9SHAREDCLASSESOPTIONS[i].flag;
//			/* Clear OMRSHR_RUNTIMEFLAG_ENABLE_BCI in case it was set earlier */
//			*runtimeFlags &= (~OMRSHR_RUNTIMEFLAG_ENABLE_BCI);
//			break;
//
...
//					*runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_STORAGEKEY_TESTING;
//				}
//			}
//
//			continue;
...
//			*runtimeFlags &= ~J9SHAREDCLASSESOPTIONS[i].flag;
//			*runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_NONFATAL;
//			break;
// 		default:
...
//	*runtimeFlags &= ~(OMRSHR_RUNTIMEFLAG_ENABLE_PERSISTENT_CACHE);
//#endif
//
//#if defined(AIXPPC)
//	if ((*runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_PERSISTENT_CACHE) != 0) {
//		I_32 coreMmapSet;
...
//
//			infoString[0] = '\0';
//			if (omrsysinfo_get_env(OPTION_ENVVAR_COREMMAP, infoString, EsMaxPath) == 0) {
...
//
//			if (!coreMmapYesSet) {
//				if ((*runtimeFlags & OMRSHR_RUNTIMEFLAG_PERSISTENT_KEYWORD) == 0) {
...
//#endif
//
//	printRuntimeFlags(OMRPORTLIB, *runtimeFlags, *verboseFlags);
//	return returnAction;
//}

//static void
//omrshr_dump_help(OMR_VM* vm, UDATA more) 
//{
//	OMRPORT_ACCESS_FROM_VMC(vm);
//
//	const char* tmpcstr = omrnls_lookup_message((J9NLS_INFO | J9NLS_DO_NOT_PRINT_MESSAGE_TAG), J9NLS_SHRC_SHRINIT_HELP_HEADER, NULL);
//	omrfile_printf( OMRPORT_TTY_OUT, "%s", tmpcstr);
//
//	IDATA i=0;
...
//			omrfile_printf( OMRPORT_TTY_OUT, " %s\n", J9SHAREDCLASSESHELPTEXT[i].option);
//		} else {
//			helptext = OMRPORTLIB->nls_lookup_message(OMRPORTLIB, (J9NLS_INFO | J9NLS_DO_NOT_APPEND_NEWLINE | J9NLS_DO_NOT_PRINT_MESSAGE_TAG),
//					(J9SHAREDCLASSESHELPTEXT[i].nlsHelp1), (J9SHAREDCLASSESHELPTEXT[i].nlsHelp2), NULL);
//			morehelptext = OMRPORTLIB->nls_lookup_message(OMRPORTLIB, (J9NLS_INFO | J9NLS_DO_NOT_APPEND_NEWLINE | J9NLS_DO_NOT_PRINT_MESSAGE_TAG),
...
//				 */
//					omrfile_printf( OMRPORT_TTY_OUT, " %s\n", J9SHAREDCLASSESHELPTEXT[i].option);
//					omrfile_printf( OMRPORT_TTY_OUT, " %28s", "");
//					omrfile_printf( OMRPORT_TTY_OUT, helptext);
//				} else {
//					omrfile_printf( OMRPORT_TTY_OUT, " %-28.28s", J9SHAREDCLASSESHELPTEXT[i].option);
//					omrfile_printf( OMRPORT_TTY_OUT, helptext);
//				}
...
//					omrfile_printf( OMRPORT_TTY_OUT, " %s\n", J9SHAREDCLASSESHELPTEXT[i].option);
//					omrfile_printf( OMRPORT_TTY_OUT, " %28s", "");
//					omrfile_printf( OMRPORT_TTY_OUT, morehelptext);
//				} else {
//					omrfile_printf( OMRPORT_TTY_OUT, " %-28.28s", J9SHAREDCLASSESHELPTEXT[i].option);
//					omrfile_printf( OMRPORT_TTY_OUT, morehelptext);
//				}
...
//	tmpcstr = omrnls_lookup_message((J9NLS_INFO | J9NLS_DO_NOT_PRINT_MESSAGE_TAG), J9NLS_SHRC_SHRINIT_HELP_OTHEROPTS_HEADER, NULL);
//	omrfile_printf( OMRPORT_TTY_OUT, "%s", tmpcstr);
//
//	tmpcstr = omrnls_lookup_message((J9NLS_INFO | J9NLS_DO_NOT_PRINT_MESSAGE_TAG), J9NLS_EXELIB_INTERNAL_HELP_XSCMX_V1, NULL);
//	omrfile_printf( OMRPORT_TTY_OUT, "%s", tmpcstr);
//
//	tmpcstr = omrnls_lookup_message((J9NLS_INFO | J9NLS_DO_NOT_PRINT_MESSAGE_TAG), J9NLS_EXELIB_INTERNAL_HELP_XSCDMX, NULL);
//	omrfile_printf( OMRPORT_TTY_OUT, "%s", tmpcstr);
//	
//	tmpcstr = omrnls_lookup_message((J9NLS_INFO | J9NLS_DO_NOT_PRINT_MESSAGE_TAG), J9NLS_EXELIB_INTERNAL_HELP_XSCMINAOT, NULL);
//	omrfile_printf( OMRPORT_TTY_OUT, "%s", tmpcstr);
//	
//	tmpcstr = omrnls_lookup_message((J9NLS_INFO | J9NLS_DO_NOT_PRINT_MESSAGE_TAG), J9NLS_EXELIB_INTERNAL_HELP_XSCMAXAOT, NULL);
//	omrfile_printf( OMRPORT_TTY_OUT, "%s", tmpcstr);
//
//	tmpcstr = omrnls_lookup_message((J9NLS_INFO | J9NLS_DO_NOT_PRINT_MESSAGE_TAG), J9NLS_EXELIB_INTERNAL_HELP_XSCMINJITDATA, NULL);
//	omrfile_printf( OMRPORT_TTY_OUT, "%s", tmpcstr);
//
//	tmpcstr = omrnls_lookup_message((J9NLS_INFO | J9NLS_DO_NOT_PRINT_MESSAGE_TAG), J9NLS_EXELIB_INTERNAL_HELP_XSCMAXJITDATA, NULL);
//	omrfile_printf( OMRPORT_TTY_OUT, "%s", tmpcstr);
//
//	tmpcstr = omrnls_lookup_message((J9NLS_INFO | J9NLS_DO_NOT_PRINT_MESSAGE_TAG), J9NLS_EXELIB_INTERNAL_HELP_XZERONOSHAREZIP, NULL);
//	omrfile_printf( OMRPORT_TTY_OUT, "%s", tmpcstr);
//
//	tmpcstr = omrnls_lookup_message((J9NLS_INFO | J9NLS_DO_NOT_PRINT_MESSAGE_TAG), J9NLS_EXELIB_INTERNAL_HELP_XXSHARED_CACHE_HARD_LIMIT_EQUALS, NULL);
//	omrfile_printf( OMRPORT_TTY_OUT, "%s", tmpcstr);
//
//	tmpcstr = omrnls_lookup_message((J9NLS_INFO | J9NLS_DO_NOT_PRINT_MESSAGE_TAG), J9NLS_EXELIB_INTERNAL_HELP_XXSHARECLASSESENABLEBCI, NULL);
//	omrfile_printf( OMRPORT_TTY_OUT, "%s", tmpcstr);
//
//	tmpcstr = omrnls_lookup_message((J9NLS_INFO | J9NLS_DO_NOT_PRINT_MESSAGE_TAG), J9NLS_EXELIB_INTERNAL_HELP_XXSHARECLASSESDISABLEBCI, NULL);
//	omrfile_printf( OMRPORT_TTY_OUT, "%s", tmpcstr);
//
//	omrfile_printf( OMRPORT_TTY_OUT, "\n\n");
//}
...
//static void 
//killStringFarm(OMRPortLibrary* portlib, J9SharedStringFarm* root)
//{
...
//	do {
//		next = walk->next;
//		omrmem_free_memory(walk);
//		walk = next;
//	} while (walk);
//}

//static void
//testForBytecodeModification(OMR_VM* vm)
//{
...
//		vm->sharedClassConfig->runtimeFlags |= OMRSHR_RUNTIMEFLAG_BYTECODE_AGENT_RUNNING;
//	}
//}

/* THREADING: Should be protected by the class segment mutex */
//void 
//registerStoreFilter(OMR_VM* vm, J9ClassLoader* classloader, const char* fixedName, UDATA fixedNameSize, J9Pool** filterPoolPtr)
//{
//	OMRPORT_ACCESS_FROM_VMC(vm);
//
...
//					omrmem_free_memory(theElement->classname);
//				}
//				break;
//			}
...
//				if (!(theElement->classname = (char*)omrmem_allocate_memory(fixedNameSize + 1, J9MEM_CATEGORY_CLASSES))) {
...
//void
//freeStoreFilterPool(OMR_VM* vm, J9Pool* filterPool)
//{
//	struct ClassNameFilterData* anElement;
//	pool_state aState;
//	
...
//			omrmem_free_memory(anElement->classname);
//		}
//		anElement = (struct ClassNameFilterData*)pool_nextDo(&aState);
//	}
...
//
//	if (!(localRuntimeFlags & OMRSHR_RUNTIMEFLAG_BYTECODE_AGENT_RUNNING)) {
//		testForBytecodeModification(vm);
//	}
//
//#ifdef LINUXPPC
//	compilerBugWorkaround = localRuntimeFlags & OMRSHR_RUNTIMEFLAG_CACHE_INITIALIZATION_COMPLETE;
//#endif
//
//	if (!(localRuntimeFlags & OMRSHR_RUNTIMEFLAG_CACHE_INITIALIZATION_COMPLETE) ||
//		(localRuntimeFlags & OMRSHR_RUNTIMEFLAG_DENY_CACHE_ACCESS) ||
//		((localRuntimeFlags & OMRSHR_RUNTIMEFLAG_BYTECODE_AGENT_RUNNING) &&
//		(sharedClassConfig->modContext==NULL) &&
//		(0 == (localRuntimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_BCI)))
//	) {
//		/* trace event is at level 1 and trace exit message is at level 2 as per CMVC 155318/157683  */
...
//		fixedName = (char*)omrmem_allocate_memory((fixedNameSize*sizeof(char)), J9MEM_CATEGORY_CLASSES);
//		if (!fixedName) {
...
//		&& (NULL != entryIndex)
//	) {
//		/* As modulesPathEntry(Jimage) is put ahead of classpath entries, entryIndex has been increase by 1 (in omrshr_classStoreTransaction_start()) when stored in the cache.
...
//	}
//
//	if (localRuntimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_TRACECOUNT) {
...
//	}
//
//	if (localVerboseFlags & OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE_IO) {
//		/*
...
omrshr_storeCompiledMethod(OMR_VMThread* currentThread, const MethodNameAndSignature* methodNameAndSignature, const U_8* dataStart, UDATA dataSize, const U_8* codeStart, UDATA codeSize, UDATA forceReplace)
{
	...
	if (!(localRuntimeFlags & OMRSHR_RUNTIMEFLAG_CACHE_INITIALIZATION_COMPLETE) || 
		(localRuntimeFlags & OMRSHR_RUNTIMEFLAG_DENY_CACHE_UPDATES)) {
		Trc_SHR_INIT_storeCompiledMethod_exit_Noop(currentThread);
		return NULL;
	}
	
	if (0 != (localRuntimeFlags & OMRSHR_RUNTIMEFLAG_AOT_SPACE_FULL)) {
		return (U_8*)OMRSHR_RESOURCE_STORE_FULL;
	}
	...
	returnVal = (U_8*)(cm->storeCompiledMethod(currentThread, methodNameAndSignature, dataStart, dataSize, codeStart, codeSize, forceReplace));

	if (localVerboseFlags & OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE_AOT) {
		if (returnVal) {
			SHRINIT_TRACE1_NOTAG(localVerboseFlags, J9NLS_SHRC_SHRINIT_STORED_VERBOSE_AOT_MSG, methodNameAndSignature);
		} else {
			SHRINIT_TRACE1_NOTAG(localVerboseFlags, J9NLS_SHRC_SHRINIT_STORE_FAILED_VERBOSE_AOT_MSG, methodNameAndSignature);
		}
	}
 ...
 */
//UDATA 
//omrshr_getJavacoreData(OMR_VM *vm, J9SharedClassJavacoreDataDescriptor* descriptor)
//{
 ...
 */
UDATA
omrshr_existsCachedCodeForROMMethod(OMR_VMThread* currentThread, const MethodNameAndSignature* methodNameAndSignature)
{
	return (((SH_CacheMap*)(currentThread->_vm->sharedClassConfig->sharedClassCache))->existsCachedCodeForROMMethodInline(currentThread, methodNameAndSignature));
}
 ...
 *     OMRSHRDATA_IS_PRIVATE indicates that the memory is private
 *     OMRSHRDATA_PRIVATE_TO_DIFFERENT_JVM indicates that the data is not private to this JVM, but does not mean that the JVM
...
omrshr_findSharedData(OMR_VMThread* currentThread, const char* key, UDATA keylen, UDATA limitDataType, UDATA includePrivateData, OMRSharedDataDescriptor* firstItem, const J9Pool* descriptorPool)
{
	...
	if (localVerboseFlags & OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE_DATA) {
		if (returnVal) {
 ...
 *     Use OMRSHRDATA_IS_PRIVATE to allocate private memory
 *     Use OMRSHRDATA_ALLOCATE_ZEROD_MEMORY to allocate zero'd memory (data->address is ignored)
 *     Use OMRSHRDATA_NOT_INDEXED to indicate that the data does not need to be indexed (will not be returned by findSharedData)
 * 
 * @param[in] vmThread  The current thread
...
omrshr_storeSharedData(OMR_VMThread* currentThread, const char* key, UDATA keylen, const OMRSharedDataDescriptor* data)
{
	...
	if (!(localRuntimeFlags & OMRSHR_RUNTIMEFLAG_CACHE_INITIALIZATION_COMPLETE) || 
		(OMR_ARE_ANY_BITS_SET(localRuntimeFlags, OMRSHR_RUNTIMEFLAG_BLOCK_SPACE_FULL | OMRSHR_RUNTIMEFLAG_DENY_CACHE_UPDATES))
	) {
		Trc_SHR_INIT_storeSharedData_exit_Noop(currentThread);
		return NULL;
	}

	if (OMR_ARE_ANY_BITS_SET(localRuntimeFlags, OMRSHR_RUNTIMEFLAG_AVAILABLE_SPACE_FULL)) {
		if (OMR_ARE_ALL_BITS_SET(data->flags, OMRSHRDATA_USE_READWRITE)) {
			/* softmx has no effect on the read write area */
			if (OMR_ARE_NO_BITS_SET(data->flags, OMRSHRDATA_NOT_INDEXED | OMRSHRDATA_IS_PRIVATE)) {
				// cm->increaseUnstoredBytes(sizeof(ByteDataWrapper));
			}
		} else {
//			U_32 wrapperLength = (OMR_ARE_ALL_BITS_SET(data->flags, OMRSHRDATA_NOT_INDEXED) ? 0 : sizeof(ByteDataWrapper));
...
* @return OMRSHR_RESOURCE_STORE_EXISTS if the attached data already exists
...
omrshr_storeAttachedData(OMR_VMThread* currentThread, const void* addressInCache, const OMRSharedDataDescriptor* data, UDATA forceReplace)
{
	...
	if (sharedClassConfig == NULL) {
		...
		return OMRSHR_RESOURCE_PARAMETER_ERROR;
	}
	...
	if (!(localRuntimeFlags & OMRSHR_RUNTIMEFLAG_CACHE_INITIALIZATION_COMPLETE) ||
		(localRuntimeFlags & OMRSHR_RUNTIMEFLAG_DENY_CACHE_UPDATES) ||
		(localRuntimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_READONLY)
	){
		Trc_SHR_INIT_storeAttachedData_exit_localRTF(currentThread, localRuntimeFlags);
		return OMRSHR_RESOURCE_STORE_ERROR;
	}

	if (localRuntimeFlags & OMRSHR_RUNTIMEFLAG_JIT_SPACE_FULL) {
		Trc_SHR_INIT_storeAttachedData_exit_CacheFull(currentThread);
		return OMRSHR_RESOURCE_STORE_FULL;
	}

	if ((OMRSHR_ATTACHED_DATA_TYPE_JITPROFILE != data->type)
		&& (OMRSHR_ATTACHED_DATA_TYPE_JITHINT != data->type)) {
		Trc_SHR_INIT_storeAttachedData_exit_TypeUnknown(currentThread, data->type);
		return OMRSHR_RESOURCE_PARAMETER_ERROR;
	}

	if (OMRSHR_ATTACHED_DATA_NO_FLAGS != data->flags) {
...
* a vm exit occurred while a call to omrshr_updateAttachedData() was in progress.
...
* @return OMRSHR_RESOURCE_BUFFER_ALLOC_FAILED if data->address is NULL and failed to allocate memory for data buffer
...
#if defined(OMRSHR_CACHELET_SUPPORT)
	return (U_8*)OMRSHR_RESOURCE_STORE_ERROR;
#endif

	if (sharedClassConfig == NULL) {
		Trc_SHR_INIT_findAttachedData_exit_SccN(currentThread);
		return (U_8*)OMRSHR_RESOURCE_PARAMETER_ERROR;
	}
...
*
* @return 0 on success
* @return OMRSHR_RESOURCE_STORE_ERROR if an error occurred storing the data
*	 	This will occur if OMRSHR_CACHELET_SUPPORT is defined
...
* @return OMRSHR_RESOURCE_PARAMETER_ERROR shared class configuration is missing.
*/
UDATA
 ...
 * OMRSHRDATA_PRIVATE_TO_DIFFERENT_JVM flag set. If the function succeeds, the data record is now
...
omrshr_acquirePrivateSharedData(OMR_VMThread* currentThread, const OMRSharedDataDescriptor* data)
{
	...
	return ((SH_CacheMap*)(currentThread->_vm->sharedClassConfig->sharedClassCache))->acquirePrivateSharedData(currentThread, data);
}
...
omrshr_releasePrivateSharedData(OMR_VMThread* currentThread, const OMRSharedDataDescriptor* data)
{
	...
	return ((SH_CacheMap*)(currentThread->_vm->sharedClassConfig->sharedClassCache))->releasePrivateSharedData(currentThread, data);
}
...
//void
//omrshr_resetSharedStringTable(OMR_VM* vm)
//{
//	J9SharedInvariantInternTable* table = vm->sharedInvariantInternTable;
//
//	UDATA verboseIntern = (vm->sharedClassConfig->verboseFlags & OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE_INTERN);
//
//	OMRPORT_ACCESS_FROM_VMC(vm);
//
//	if (table) {
...
//		if (verboseIntern) {
//			omrtty_printf("Resetting shared string table...\n");
//		}
...
reportUtilityNotApplicable(OMR_VM* vm, const char* ctrlDirName, const char* cacheName, UDATA verboseFlags, U_64 runtimeFlags, UDATA command)
{
	...
	if ((runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_GROUP_ACCESS) != 0) {
		groupPerm = 1;
	}
	...
	if (RESULT_DO_PRINTSTATS == command) {
		optionName = ((runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_DETAILED_STATS) != 0) ? OPTION_PRINTDETAILS : OPTION_PRINTSTATS;
	} else {
...
static void omrshr_printStats_dump_help(OMR_VM* vm, bool moreHelp, bool helpForPrintStats)
{
	OMRPORT_ACCESS_FROM_VMC(vm);
...
{
        if (0 != (runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_PERSISTENT_CACHE)) {
                return OMRPORT_SHR_CACHE_TYPE_PERSISTENT;
        } else {
                return OMRPORT_SHR_CACHE_TYPE_NONPERSISTENT;
        }
}
...
//		omrshr_dump_help(vm, (command==RESULT_DO_MORE_HELP));
//		break;
//	case RESULT_DO_DESTROY: 
//	case RESULT_DO_RESET:
//		setCurrentCacheVersion(vm, J2SE_VERSION(vm), &versionData);
//		versionData.cacheType = cacheType;
//		omrshr_destroy_cache(vm, sharedClassConfig->ctrlDirName, verboseFlags, cacheName, OSCACHE_LOWEST_ACTIVE_GEN, OSCACHE_CURRENT_CACHE_GEN, &versionData, (RESULT_DO_RESET == command));
...
//		break;
//	case RESULT_DO_DESTROYALL:
//		omrshr_destroy_all_cache(vm, sharedClassConfig->ctrlDirName, groupPerm, verboseFlags);
//		break;
//#if !defined(WIN32)
//	case RESULT_DO_DESTROYSNAPSHOT:
//		setCurrentCacheVersion(vm, J2SE_VERSION(vm), &versionData);
//		versionData.cacheType = OMRPORT_SHR_CACHE_TYPE_SNAPSHOT;
//		omrshr_destroy_snapshot(vm, sharedClassConfig->ctrlDirName, verboseFlags, cacheName, OSCACHE_LOWEST_ACTIVE_GEN, OSCACHE_CURRENT_CACHE_GEN, &versionData);
//		break;
//	case RESULT_DO_DESTROYALLSNAPSHOTS:
//		omrshr_destroy_all_snapshot(vm, sharedClassConfig->ctrlDirName, groupPerm, verboseFlags);
//		break;
//	case RESULT_DO_RESTORE_FROM_SNAPSHOT:
//	case RESULT_DO_SNAPSHOTCACHE:
//		if (OMR_ARE_ALL_BITS_SET(runtimeFlags, OMRSHR_RUNTIMEFLAG_ENABLE_PERSISTENT_CACHE)) {
...
//#endif /* !defined(WIN32) */
//	case RESULT_DO_LISTALLCACHES:
//		omrshr_list_caches(vm, sharedClassConfig->ctrlDirName, groupPerm, verboseFlags);
//		break;
//	case RESULT_DO_EXPIRE:
//		/**
...
//					omrshr_destroy_expire_cache(vm, sharedClassConfig->ctrlDirName, groupPerm, verboseFlags, expireTimeVal);
//					return 0;
//				}
//			}
//			
//			SHRINIT_ERR_TRACE1(verboseFlags, J9NLS_SHRC_SHRINIT_EXPIRE_WRONG_PARAM, cacheName);
//			omrshr_dump_help(vm, 0);                                                                                 
//		} while(false);
//		break;
//	case RESULT_DO_PRINTSTATS:
//	case RESULT_DO_PRINTALLSTATS:
...
//				omrshr_printStats_dump_help(vm, true, (RESULT_DO_PRINTSTATS_EQUALS == command));
//				break;
//			} else if (printStatsOptions & PRINTSTATS_SHOW_HELP) {
//				omrshr_printStats_dump_help(vm, false, (RESULT_DO_PRINTSTATS_EQUALS == command));
//				break;
//			}
//			/* Test for existence of cache first. If it exists, proceed with cache init */
...
//
//	case RESULT_DO_PRINT_CACHENAME:
//		if (SH_OSCache::getCacheDir(vm, sharedClassConfig->ctrlDirName, cacheDirName, OMRSH_MAXPATH, cacheType) == -1) {
//			return J9VMDLLMAIN_SILENT_EXIT_VM;
//		}
//		omrshr_print_cache_filename(vm, cacheDirName, runtimeFlags, cacheName);
//		break;
//
//	case RESULT_DO_PRINT_SNAPSHOTNAME:
//		if (-1 == SH_OSCache::getCacheDir(vm, sharedClassConfig->ctrlDirName, cacheDirName, OMRSH_MAXPATH, OMRPORT_SHR_CACHE_TYPE_SNAPSHOT)) {
//			return J9VMDLLMAIN_SILENT_EXIT_VM;
//		}
//		omrshr_print_snapshot_filename(vm, cacheDirName, cacheName);
//		break;
//
//	case RESULT_DO_INVALIDATE_AOT_METHODS_EQUALS:
//	case RESULT_DO_REVALIDATE_AOT_METHODS_EQUALS:
...
bool
modifyCacheName(OMR_VM *vm, const char* origName, UDATA verboseFlags, char** modifiedCacheName, UDATA bufLen)
{
	UDATA origNameLen;
	...
	if (strcmp(origName, CACHE_ROOT_PREFIX)==0) {
		...
		if( (origNameLen + 2) < bufLen) {
			...
			if (omrsysinfo_get_username(&((*modifiedCacheName)[modIndex]), bufLeft) != 0) {
				char username[CACHE_ROOT_MAXLEN];
				if (omrsysinfo_get_username(username, CACHE_ROOT_MAXLEN) == 0) {
			...
			*cursorOrig == '?')	{
			...
			if (*cursorOrig == '%') {
				...
				case 'G':
					 ...
					 */
					if (omrsysinfo_get_groupname(&((*modifiedCacheName)[modIndex]), bufLeft) > 0) {
...
UDATA
convertPermToDecimal(OMR_VM *vm, const char *permStr) {
	I_32 permStrLen;
	OMRPORT_ACCESS_FROM_VMC(vm);

	if (NULL == permStr) {
		/* This means cacheDirPerm is not present */
		return OMRSH_DIRPERM_ABSENT;
	}
...
ensureCorrectCacheSizes(OMR_VM *vm, OMRPortLibrary* portlib, U_64 runtimeFlags, UDATA verboseFlags, OMRSharedCachePreinitConfig* piconfig)
{
	...
	U_64 maxSize = 0;
	if (OMRPORT_SHR_CACHE_TYPE_NONPERSISTENT == getCacheTypeFromRuntimeFlags(runtimeFlags)) {
		if ((OMRPORT_LIMIT_LIMITED == omrsysinfo_get_limit(OMRPORT_RESOURCE_SHARED_MEMORY, &maxSize))
			&& (*cacheSize > maxSize)
		) {
	...
	if (piconfig->sharedClassInternTableNodeCount > -1) {
		if (piconfig->sharedClassInternTableNodeCount == 0) {
			...
			piconfig->sharedClassReadWriteBytes = 0;//(UDATA)srpHashTable_requiredMemorySize((U_32)piconfig->sharedClassInternTableNodeCount, sizeof(J9SharedInternSRPHashTableEntry), TRUE);
 ...
 */
SCAbstractAPI *
initializeSharedAPI(OMR_VM *vm)
{
	SCAbstractAPI *scapi;

	OMRPORT_ACCESS_FROM_VMC(vm);

	scapi = (SCAbstractAPI *)omrmem_allocate_memory(sizeof(SCAbstractAPI), OMRMEM_CATEGORY_CLASSES);
	if (NULL == scapi) {
		return NULL;
	}

	/*Set functions for SCStringTransaction*/
//	scapi->stringTransaction_start = omrshr_stringTransaction_start;
//	scapi->stringTransaction_stop = omrshr_stringTransaction_stop;
//	scapi->stringTransaction_IsOK = omrshr_stringTransaction_IsOK;
	/*Set functions for SCStoreTransaction*/
//	scapi->classStoreTransaction_start = omrshr_classStoreTransaction_start;
//	scapi->classStoreTransaction_stop = omrshr_classStoreTransaction_stop;
//	scapi->classStoreTransaction_nextSharedClassForCompare = omrshr_classStoreTransaction_nextSharedClassForCompare;
//	scapi->classStoreTransaction_createSharedClass = omrshr_classStoreTransaction_createSharedClass;
//	scapi->classStoreTransaction_updateSharedClassSize = omrshr_classStoreTransaction_updateSharedClassSize;
//	scapi->classStoreTransaction_isOK = omrshr_classStoreTransaction_isOK;
//	scapi->classStoreTransaction_hasSharedStringTableLock = omrshr_classStoreTransaction_hasSharedStringTableLock;
	/*Set JCL functions*/
//	scapi->jclUpdateROMClassMetaData = omrshr_jclUpdateROMClassMetaData;
	/*Set up functions for finishing share classes initialization*/
	scapi->sharedClassesFinishInitialization = omrshr_sharedClassesFinishInitialization;
...
//
//	if (verboseIntern) {
//		omrtty_printf("Initializing shared string table...\n");
//	}
//
//	if (!table) {
//		if (verboseIntern) {
//			omrtty_printf("   FAILED due to string interning disabled\n");
//		}
//		return 0;
//	}
//
...
//
//    if (verboseIntern) {
//		omrtty_printf("   Created new shared string table.  sharedHead=%d, sharedTail=%d\n",
//				*(table->sharedHeadNodePtr), *(table->sharedTailNodePtr));
//	}
//
//	if (verboseIntern) {
//		omrtty_printf("   Creating a new string intern srphashtable...\n");
//	}
//
...
//			omrtty_printf("      sharedTable->tailNode = %p\n", table->tailNode);
//		}
//	} else {
//		if (verboseIntern) {
//			omrtty_printf("No existing shared table data\n");
//		}
//	}
//	table->flags |= J9AVLTREE_SHARED_TREE_INITIALIZED;
//	if ((sharedClassConfig->runtimeFlags & OMRSHR_RUNTIMEFLAG_VERIFY_TREE_AND_TREE_ACCESS) != 0 ) {
//		table->flags |= J9AVLTREE_DO_VERIFY_TREE_STRUCT_AND_ACCESS;
//	}
////	table->systemClassLoader = vm->systemClassLoader;
//
//	if (verboseIntern) {
//		omrtty_printf("Shared string table successfully initialized.\nShared table = %d nodes. \n\n", *table->totalSharedNodesPtr);
//	}
//    return 1;
//}
...
//UDATA
//omrshr_isBCIEnabled(OMR_VM *vm)
//{
//	return (0 != (vm->sharedClassConfig->runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_BCI));
//}
 ...
 */
IDATA 
omrshr_init(OMR_VM *vm, UDATA loadFlags, UDATA* nonfatal)
{
  	/* TODO: need to get root cache name from VM parameters. */
	const char * fname = "omrshr_init";
...
//	IDATA returnVal = OMR_SHARED_CACHE_INIT_FAILED; //J9VMDLLMAIN_FAILED;
	...
	if(vm->sharedCacheAPI==nullptr){
	  vm->sharedCacheAPI = new J9SharedCacheAPI();
	}
...
//		Trc_SHR_Assert_True(OMR_ARE_ALL_BITS_SET(runtimeFlags, OMRSHR_RUNTIMEFLAG_ENABLE_NONFATAL));
//		Trc_SHR_Assert_True(OMR_ARE_ALL_BITS_SET(runtimeFlags, OMRSHR_RUNTIMEFLAG_ENABLE_CACHEBOOTCLASSES));
//		Trc_SHR_Assert_True(OMR_ARE_NO_BITS_SET(runtimeFlags, OMRSHR_RUNTIMEFLAG_ENABLE_CACHE_NON_BOOT_CLASSES));
//		Trc_SHR_Assert_True(0 == vm->sharedCacheAPI->verboseFlags);
//		Trc_SHR_INIT_omrshr_init_BootClassSharingEnabledByDefault(currentThread);
//	}
//
//	if (((0 != (runtimeFlags & OMRSHR_RUNTIMEFLAG_CHECK_STRINGTABLE_RESET_READONLY)) ||
//		(0 != (runtimeFlags & OMRSHR_RUNTIMEFLAG_CHECK_STRINGTABLE_RESET_READWRITE))) &&
//		(0 == (runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_ROUND_TO_PAGE_SIZE)))
//	{
//		/* CMVC 176498 : When testing string table reset,
//		 * ensure OMRSHR_RUNTIMEFLAG_ENABLE_ROUND_TO_PAGE_SIZE is set.
//		 */
...
//		if (runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_READONLY) {
...
//#endif
	 ...
	 * protected.
	 */
//	if (((runtimeFlags & OMRSHR_RUNTIMEFLAG_VERIFY_TREE_AND_TREE_ACCESS) == OMRSHR_RUNTIMEFLAG_VERIFY_TREE_AND_TREE_ACCESS) ||
//		(parseResult == RESULT_DO_TEST_INTERNAVL)
//	) {
//		if ( runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_ALL ) {
//			runtimeFlags &= ~(OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_ALL | OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_RW);
//			runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT;
//		} else if ( runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_RW ) {
//			runtimeFlags &= ~(OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_RW);
//		}
//	}
//
...
//		runtimeFlags |= OMRSHR_RUNTIMEFLAG_ENABLE_STATS;
//		runtimeFlags &= ~OMRSHR_RUNTIMEFLAG_ENABLE_REDUCE_STORE_CONTENTION;
//		runtimeFlags &= ~OMRSHR_RUNTIMEFLAG_ENABLE_TEST_BAD_BUILDID;
//		runtimeFlags &= ~OMRSHR_RUNTIMEFLAG_AUTOKILL_DIFF_BUILDID;
//
//		/* Ignore incompatible options as we just want to get stats on it */
//		runtimeFlags &= ~(OMRSHR_RUNTIMEFLAG_ENABLE_CACHERETRANSFORMED | OMRSHR_RUNTIMEFLAG_ENABLE_BCI);
//	}
//	
...
//		if ((0 != (runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_CACHERETRANSFORMED))
//			&& (0 != (runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_BCI))
//		) {
...
//	}
	 ...
	 */
	//tempConfig->getJavacoreData = omrshr_getJavacoreData;
...
//		rcStartup = omrshr_restoreFromSnapshot(vm, ctrlDirName, cacheName, &cacheExist);
//		if (0 == rcStartup) {
...
//		J9TranslationBufferSet* translationBuffers = vm->dynamicLoadBuffers;
	  ...
	  config->getCacheSizeBytes = omrshr_getCacheSizeBytes;
	  config->getTotalUsableCacheBytes = omrshr_getTotalUsableCacheBytes;
	  config->getMinMaxBytes = omrshr_getMinMaxBytes;
	  config->setMinMaxBytes = omrshr_setMinMaxBytes;
	  config->increaseUnstoredBytes = omrshr_increaseUnstoredBytes;
	  config->getUnstoredBytes = omrshr_getUnstoredBytes;
	  config->getFreeSpaceBytes = omrshr_getFreeAvailableSpaceBytes;
	  config->findSharedData = omrshr_findSharedData;
	  config->storeSharedData = omrshr_storeSharedData;
	  config->findCompiledMethodEx1 = omrshr_findCompiledMethodEx1;
	  config->storeCompiledMethod = omrshr_storeCompiledMethod;
	  config->storeAttachedData = omrshr_storeAttachedData;
	  config->findAttachedData = omrshr_findAttachedData;
	  config->updateAttachedData = omrshr_updateAttachedData;
	  config->updateAttachedUDATA = omrshr_updateAttachedUDATA;
	  config->freeAttachedDataDescriptor = omrshr_freeAttachedDataDescriptor;
	  config->existsCachedCodeForROMMethod = omrshr_existsCachedCodeForROMMethod;
	  config->acquirePrivateSharedData = omrshr_acquirePrivateSharedData;
	  config->releasePrivateSharedData = omrshr_releasePrivateSharedData;
	  //	config->isBCIEnabled = omrshr_isBCIEnabled;
	  //	config->freeClasspathData = omrshr_freeClasspathData;
	  //	config->jvmPhaseChange = omrshr_jvmPhaseChange;
...
//				(0 ==(runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_STATS)))
//		{
//			if (!(vm->sharedClassConfig->runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_READONLY)) {
...
//						UDATA resetReason = OMRSHR_STRING_POOL_OK;
//
//						/*-----SRPHASHTABLE------------------*/
//						vm->sharedInvariantInternTable = (J9SharedInvariantInternTable *) omrmem_allocate_memory((UDATA) sizeof(J9SharedInvariantInternTable), J9MEM_CATEGORY_CLASSES);
...
//						 */
//						cm->updateRuntimeFullFlags(currentThread);
//						if (OMR_ARE_ANY_BITS_SET(vm->sharedClassConfig->runtimeFlags, OMRSHR_RUNTIMEFLAG_BLOCK_SPACE_FULL | OMRSHR_RUNTIMEFLAG_AVAILABLE_SPACE_FULL)) {
...
//											verifyError = 1;
//											resetReason = OMRSHR_STRING_POOL_FAILED_VERIFY;
//										} else {
...
//												verifyError = 1;
//												resetReason = OMRSHR_STRING_POOL_FAILED_CONSISTENCY;
//											}
//										}
//									} else {
//										verifyError = 1;
...
//								}
//							} else {
//								omrmem_free_memory(vm->sharedInvariantInternTable);
...
//								omrshr_resetSharedStringTable(vm);
//							}
//							cm->exitStringTableMutex(currentThread, resetReason);
//						}
//					cm->exitClassTransaction(currentThread, fname);
...
//		(*shcHooks)->J9HookRegisterWithCallSite(shcHooks, J9HOOK_VM_ZIP_LOAD, omrshr_hookZipLoadEvent, OMR_GET_CALLSITE(), NULL);
	}
//
//	if (0 != (runtimeFlags & OMRSHR_RUNTIMEFLAG_ADD_TEST_JITHINT)) {
//		J9HookInterface** hook = vm->internalVMFunctions->getVMHookInterface(vm);
//		(*hook)->J9HookRegisterWithCallSite(hook, J9HOOK_VM_FIND_LOCALLY_DEFINED_CLASS, addTestJitHint, OMR_GET_CALLSITE(), NULL);
//	}
//
//	if (doPrintStats) {
//		if (omrshr_print_stats(vm, parseResult, runtimeFlags, printStatsOptions) != -1) {
...
//
//		*nonfatal = 0;
//		numMethods = omrshr_aotMethodOperation(vm, vm->sharedCacheAPI->methodSpecs, SHR_INVALIDATE_AOT_METHOTHODS);
//		if (numMethods > 0) {
//			if (verboseFlags > 0) {
//				omrtty_printf("\n");
//			}
...
//
//		*nonfatal = 0;
//		numMethods = omrshr_aotMethodOperation(vm, vm->sharedCacheAPI->methodSpecs, SHR_REVALIDATE_AOT_METHOTHODS);
//		if (numMethods > 0) {
//			if (verboseFlags > 0) {
//				omrtty_printf("\n");
//			}
...
//		*nonfatal = 0;
//
//		numMethods = omrshr_aotMethodOperation(vm, vm->sharedCacheAPI->methodSpecs, SHR_FIND_AOT_METHOTHODS);
//		if (numMethods > 0) {
//			if (verboseFlags > 0) {
//				omrtty_printf("\n");
//			}
...
//		*nonfatal = 0;
//		if (0 == omrshr_createCacheSnapshot(vm, cacheName)) {
...
_error:
	...
	if (vm->sharedClassConfig) {
		if (*nonfatal) {
			 ...
			 */
			vm->sharedClassConfig->runtimeFlags |= OMRSHR_RUNTIMEFLAG_DO_DESTROY_CONFIG;
			omrshr_sharedClassesFinishInitialization(vm);
			Trc_SHR_INIT_j9shr_init_ExitOnNonFatal(currentThread);
		} else {
			if (vm->sharedClassConfig->sharedAPIObject != NULL) {
				omrmem_free_memory(vm->sharedClassConfig->sharedAPIObject);
			}
			omrmem_free_memory(vm->sharedClassConfig);
			vm->sharedClassConfig = NULL;
		}
	}
	if (((doPrintStats) && (-2 == rcStartup))
		...
		return OMR_SHARED_CACHE_INIT_SILENT_EXIT; // return J9VMDLLMAIN_SILENT_EXIT_VM;
	}
	return OMR_SHARED_CACHE_INIT_FAILED; // return J9VMDLLMAIN_FAILED;
}
 ...
 */
IDATA 
omrshr_lateInit(OMR_VM *vm, UDATA* nonfatal)
{
	IDATA returnVal = OMR_SHARED_CACHE_INIT_FAILED;
	OMRPORT_ACCESS_FROM_OMRPORT(vm->_runtime->_portLibrary);

	if (vm->sharedClassConfig) {
		U_64 rFlags = vm->sharedClassConfig->runtimeFlags;

		*nonfatal = (rFlags & OMRSHR_RUNTIMEFLAG_ENABLE_NONFATAL) != 0;
		if (rFlags & OMRSHR_RUNTIMEFLAG_DO_DESTROY_CONFIG) {
			omrmem_free_memory(vm->sharedClassConfig);
			vm->sharedClassConfig = NULL;
			returnVal = OMR_SHARED_CACHE_INIT_FAILED; //J9VMDLLMAIN_FAILED;
		} else {
			/* If bytecode agent has hooked, try to detect this early on... this is also tested on each class load */
//			testForBytecodeModification(vm);
			returnVal = OMR_SHARED_CACHE_INIT_OK; // J9VMDLLMAIN_OK;
		}
	}
...
omrshr_print_cache_filename(OMR_VM* vm, const char* cacheDirName, U_64 runtimeFlags, const char* cacheName)
{	
	char cacheNameWithVGen[OMRSH_MAXPATH];
	OMRPORT_ACCESS_FROM_VMC(vm);	
	J9PortShcVersion versionData;
	
	memset(cacheNameWithVGen, 0, OMRSH_MAXPATH);	
 ...
 */
UDATA
omrshr_getCacheSizeBytes(OMR_VM *vm)
{
	U_32 ret = 0;
	
	omrshr_getMinMaxBytes(vm, &ret, NULL, NULL, NULL, NULL);
	if ((U_32)-1 == ret) {
		ret = (U_32)omrshr_getTotalUsableCacheBytes(vm);
	}
 ...
 */
UDATA
omrshr_getTotalUsableCacheBytes(OMR_VM *vm)
{
 ...
 */
void
omrshr_getMinMaxBytes(OMR_VM *vm, U_32 *softmx, I_32 *minAOT, I_32 *maxAOT, I_32 *minJIT, I_32 *maxJIT)
{
 ...
 */
I_32
omrshr_setMinMaxBytes(OMR_VM *vm, U_32 softmx, I_32 minAOT, I_32 maxAOT, I_32 minJIT, I_32 maxJIT)
{
	OMR_VMThread* currentThread = omr_vmthread_getCurrent(vm); //vm->internalVMFunctions->currentVMThread(vm);
 ...
 */
void
omrshr_increaseUnstoredBytes(OMR_VM *vm, U_32 aotBytes, U_32 jitBytes)
{
 ...
 */
void
omrshr_getUnstoredBytes(OMR_VM *vm, U_32 *softmxUnstoredBytes, U_32 *maxAOTUnstoredBytes, U_32 *maxJITUnstoredBytes)
{
 ...
 */
UDATA
omrshr_getFreeAvailableSpaceBytes(OMR_VM *vm)
{
	return ((SH_CacheMap*)vm->sharedClassConfig->sharedClassCache)->getCompositeCacheAPI()->getFreeAvailableBytes();
}

static void 
freeClasspathItemsForPool(OMR_VM* vm, J9Pool* pool, UDATA alsoFreeCpEntries)
{
	OMRPORT_ACCESS_FROM_VMC(vm);
	...
	if (pool) {
		...
		while (anElement) {
			...
			if (alsoFreeCpEntries && anElement->jclData) {
				omrmem_free_memory(anElement->jclData);
			}
 ...
 */
void 
omrshr_guaranteed_exit(OMR_VM *vm, BOOLEAN exitForDebug)
{
	...
	if (vm && vm->sharedClassConfig && vm->sharedClassConfig->sharedClassCache) {
		...
		if (exitForDebug == TRUE) {	
			OMRPORT_ACCESS_FROM_VMC(vm);
			omrtty_printf("CALL :\t omrshr_guaranteed_exit\n");
			 ...
			 * In this case we make sure all the hooks registered by omrshr_init are disabled.
			 */
//			J9HookInterface** hook = vm->internalVMFunctions->getVMHookInterface(vm);
//			(*hook)->J9HookUnregister(hook, J9HOOK_VM_FIND_LOCALLY_DEFINED_CLASS, hookFindSharedClass, NULL);

#if defined(OMRSHR_CACHELET_SUPPORT)
			if (vm->sharedClassConfig->runtimeFlags & OMRSHR_RUNTIMEFLAG_ENABLE_NESTED) {
				(*hook)->J9HookUnregister(hook, J9HOOK_VM_SERIALIZE_SHARED_CACHE, hookSerializeSharedCache, NULL);
			}
#endif
//			J9HookInterface **shcHooks;
//			shcHooks = zip_getVMZipCachePoolHookInterface((J9ZipCachePool *)vm->zipCachePool);
//			(*shcHooks)->J9HookUnregister(shcHooks, J9HOOK_VM_ZIP_LOAD, omrshr_hookZipLoadEvent, NULL);
...
//			}
		...
		((SH_CacheMap*)vm->sharedClassConfig->sharedClassCache)->runExitCode(omr_vmthread_getCurrent(vm)); //vm->mainThread);
	}
}
 ...
 * (See @ref omrshr_guaranteed_exit which is called in both cases)
 *
 * @param [in] vm Pointer to the VM structure for the JVM
 */
void 
omrshr_shutdown(OMR_VM *vm)
{
	OMRPORT_ACCESS_FROM_VMC(vm);
	...
	if (vm->sharedCacheAPI != NULL)
	{
		if (vm->sharedCacheAPI->cacheName != NULL) {
			omrmem_free_memory(vm->sharedCacheAPI->cacheName);
		}
		if (vm->sharedCacheAPI->ctrlDirName != NULL) {
			omrmem_free_memory(vm->sharedCacheAPI->ctrlDirName);
		}
		if (vm->sharedCacheAPI->modContext != NULL) {
			omrmem_free_memory(vm->sharedCacheAPI->modContext);
		}
		if (vm->sharedCacheAPI->expireTime != NULL) {
			omrmem_free_memory(vm->sharedCacheAPI->expireTime);
		}
		if (NULL != vm->sharedCacheAPI->methodSpecs) {
			omrmem_free_memory(vm->sharedCacheAPI->methodSpecs);
		}
		omrmem_free_memory(vm->sharedCacheAPI);
	}
//	if (vm->sharedInvariantInternTable != NULL) {
//		if (vm->sharedInvariantInternTable->sharedInvariantSRPHashtable != NULL) {
//			srpHashTableFree(vm->sharedInvariantInternTable->sharedInvariantSRPHashtable);
...
//		omrmem_free_memory(config->bootstrapCPI);
...
//		}
		omrmem_free_memory(config->sharedAPIObject);
		omrmem_free_memory(config);
...
IDATA
omrshr_sharedClassesFinishInitialization(OMR_VM *vm)
{
	IDATA rc = OMR_SHARED_CACHE_INIT_OK;
	UDATA nonfatal = 0;
	OMRPORT_ACCESS_FROM_VMC(vm);

	if ((rc = omrshr_lateInit(vm, &nonfatal)) != OMR_SHARED_CACHE_INIT_OK) {
		if (nonfatal) {
			SHRINIT_TRACE(vm->sharedCacheAPI->verboseFlags, J9NLS_SHRC_SHRINIT_FAILED_NONFATAL_PRESENT);
			return OMR_SHARED_CACHE_INIT_OK;
		} else {
			return rc;
		}
	}
...
/* TODO:@hangshao Rename this method to omrshr_isCacheBlockSpaceFull() */
BOOLEAN
omrshr_isCacheFull(OMR_VM *vm)
{
	...
	if (vm->sharedClassConfig) {
		...
		cm->updateRuntimeFullFlags(currentThread);
		if (OMR_ARE_ALL_BITS_SET(vm->sharedClassConfig->runtimeFlags, OMRSHR_RUNTIMEFLAG_BLOCK_SPACE_FULL)) {
			retval = TRUE;
		}
	}
	return retval;
 ...
 */
BOOLEAN
omrshr_isAddressInCache(OMR_VM *vm, void *address, UDATA length)
{
	BOOLEAN retval = FALSE;
 ...
 */
BOOLEAN
omrshr_isPlatformDefaultPersistent(struct OMR_VM* vm)
{
...
{
	return (
			OMRSHR_RUNTIMEFLAG_ENABLE_LOCAL_CACHEING |
			OMRSHR_RUNTIMEFLAG_ENABLE_TIMESTAMP_CHECKS |
			OMRSHR_RUNTIMEFLAG_ENABLE_REDUCE_STORE_CONTENTION |
			OMRSHR_RUNTIMEFLAG_ENABLE_ROUND_TO_PAGE_SIZE |
#if defined (OMRSHR_MSYNC_SUPPORT)
			OMRSHR_RUNTIMEFLAG_ENABLE_MSYNC |
#endif
			...
			OMRSHR_RUNTIMEFLAG_ENABLE_MPROTECT_PARTIAL_PAGES |
#endif
			OMRSHR_RUNTIMEFLAG_ENABLE_CACHEBOOTCLASSES |
			OMRSHR_RUNTIMEFLAG_ENABLE_CACHE_NON_BOOT_CLASSES |
			OMRSHR_RUNTIMEFLAG_ENABLE_BYTECODEFIX |
			OMRSHR_RUNTIMEFLAG_ENABLE_AOT |
			OMRSHR_RUNTIMEFLAG_ENABLE_JITDATA |
			OMRSHR_RUNTIMEFLAG_AUTOKILL_DIFF_BUILDID |
			OMRSHR_RUNTIMEFLAG_DETECT_NETWORK_CACHE |
			OMRSHR_RUNTIMEFLAG_ENABLE_SEMAPHORE_CHECK
	);
}
 ...
 */
static BOOLEAN
omrshr_parseMemSize(char * str, UDATA & value) {
...
//void
//omrshr_freeClasspathData(OMR_VM *vm, void *cpData) {
//	OMRPORT_ACCESS_FROM_VMC(vm);
//
//	if (NULL != cpData) {
//		ClasspathItem *cpi = (ClasspathItem*)cpData;
//		cpi->cleanup();
//		omrmem_free_memory(cpi);
//	}
//}
...
//
//	J9VMFindLocalClassEvent* eventData = (J9VMFindLocalClassEvent*)voidData;
//	OMR_VM* vm = eventData->currentThread->_vm;
//
//	OMRPORT_ACCESS_FROM_VMC(vm);
//
...
//	if (NULL == romclass) {
//		omrfile_printf( OMRPORT_TTY_OUT, "addTestJitHint class %.*s not in the cache\n",
 ...
 */
IDATA
omrshr_createCacheSnapshot(OMR_VM* vm, const char* cacheName)
{
	IDATA rc = 0;
#if !defined(WIN32)
	OMRPORT_ACCESS_FROM_VMC(vm);
	...
	if (-1 == SH_OSCache::getCacheDir(vm, vm->sharedClassConfig->ctrlDirName, cacheDirName, OMRSH_MAXPATH, OMRPORT_SHR_CACHE_TYPE_SNAPSHOT)) {
		...
		char pathFileName[OMRSH_MAXPATH];		/* OMRSH_MAXPATH defined to be EsMaxPath which is 1024 */
		I_32 mode = (OMR_ARE_ALL_BITS_SET(vm->sharedClassConfig->runtimeFlags, OMRSHR_RUNTIMEFLAG_ENABLE_GROUP_ACCESS)) ? J9SH_CACHE_FILE_MODE_DEFAULTDIR_WITH_GROUPACCESS : J9SH_CACHE_FILE_MODE_DEFAULTDIR_WITHOUT_GROUPACCESS;
...
//		setCurrentCacheVersion(vm, J2SE_VERSION(vm), &versionData);
		...
		fd = omrfile_open(pathFileName, EsOpenCreate | EsOpenWrite, mode);
		if (-1 == fd) {
			...
			if (OMR_ARE_ALL_BITS_SET(vm->sharedClassConfig->runtimeFlags, OMRSHR_RUNTIMEFLAG_ENABLE_GROUP_ACCESS)) {
				...
				I_32 groupAccessRc = SH_OSCacheFile::verifyCacheFileGroupAccess(OMRPORTLIB, fd, &lastErrorInfo);
			...
			lockRc1 = omrfile_lock_bytes(fd, OMRPORT_FILE_WRITE_LOCK | OMRPORT_FILE_WAIT_FOR_LOCK, 0, cacheSize + headerSize);
			...
			lockRc2 = cc->enterWriteMutex(currentThread, false, "omrshr_createCacheSnapshot");
			...
			if ((lockRc2 < 0)
				...
				fileRc = omrfile_write(fd, (void*)headerStart, nbytes);
				if (fileRc < 0) {
					I_32 errorno = omrerror_last_error_number();
					const char * errormsg = omrerror_last_error_message();
				...
				fileSeekOffset = omrfile_seek(fd, cacheInitCompleteOffset, EsSeekSet);
				...
				fileRc = omrfile_write(fd, &theCacheInitComplete, nbytes);
				if (fileRc < 0) {
					I_32 errorno = omrerror_last_error_number();
					const char * errormsg = omrerror_last_error_message();
				...
				if (OMR_ARE_ALL_BITS_SET(vm->sharedClassConfig->runtimeFlags, OMRSHR_RUNTIMEFLAG_ENABLE_TEST_BAD_BUILDID)) {
					/* OMRSHR_RUNTIMEFLAG_ENABLE_TEST_BAD_BUILDID is for testing only, change the buildID in the snapshot */
					...
					fileSeekOffset = omrfile_seek(fd, buildIDOffset, EsSeekSet);
					...
					fileRc = omrfile_write(fd, &theBadBuildID, nbytes);
					if (fileRc < 0) {
						I_32 errorno = omrerror_last_error_number();
						const char * errormsg = omrerror_last_error_message();
			...
			if (0 == lockRc3) {
				//cc->exitReadWriteAreaMutex(currentThread, OMRSHR_STRING_POOL_OK);
			}
			if (0 == lockRc2) {
				cc->exitWriteMutex(currentThread, "omrshr_createCacheSnapshot");
			}
			if (rc < 0) {
				/* delete the shared cache snapshot file in the file lock */
				omrfile_unlink(pathFileName);
			}
 ...
 */
static IDATA
omrshr_restoreFromSnapshot(OMR_VM* vm, const char* ctrlDirName, const char* cacheName, bool* cacheExist)
{
	IDATA rc = 0;
#if !defined(WIN32)
	OMRPORT_ACCESS_FROM_VMC(vm);
	...
	if (OMR_ARE_ALL_BITS_SET(vm->sharedClassConfig->runtimeFlags, OMRSHR_RUNTIMEFLAG_ENABLE_READONLY)) {
		vm->sharedClassConfig->runtimeFlags &= ~OMRSHR_RUNTIMEFLAG_ENABLE_READONLY;
 ...
 */
static void
omrshr_print_snapshot_filename(OMR_VM* vm, const char* cacheDirName, const char* snapshotName)
{
	char snapshotNameWithVGen[OMRSH_MAXPATH];
	OMRPORT_ACCESS_FROM_VMC(vm);
	J9PortShcVersion versionData;

	memset(snapshotNameWithVGen, 0, OMRSH_MAXPATH);
//	setCurrentCacheVersion(vm, J2SE_VERSION(vm), &versionData);
	versionData.cacheType = OMRPORT_SHR_CACHE_TYPE_SNAPSHOT;
 ...
 * @param[out] flags Lowest bit set to OMRSHR_AOT_METHOD_FLAG_INVALIDATED if the compiled method has been invalidated.
 *
...
omrshr_findCompiledMethodEx1(OMR_VMThread* currentThread, const MethodNameAndSignature* methodNameAndSignature, UDATA* flags)
{
	...
	if (OMR_ARE_NO_BITS_SET(localRuntimeFlags, OMRSHR_RUNTIMEFLAG_CACHE_INITIALIZATION_COMPLETE) ||
		OMR_ARE_ALL_BITS_SET(localRuntimeFlags, OMRSHR_RUNTIMEFLAG_DENY_CACHE_ACCESS)) {
		Trc_SHR_INIT_findCompiledMethod_exit_Noop(currentThread);
		return NULL;
	}
	...
	returnVal = (U_8*)(((SH_CacheMap*)(sharedClassConfig->sharedClassCache))->findCompiledMethod(currentThread, methodNameAndSignature, flags));

	if (OMR_ARE_ALL_BITS_SET(localVerboseFlags, OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE_AOT)) {
		if (returnVal) {
			SHRINIT_TRACE1_NOTAG(localVerboseFlags, J9NLS_SHRC_SHRINIT_FOUND_VERBOSE_AOT_MSG, methodNameAndSignature);
		} else {
			SHRINIT_TRACE1_NOTAG(localVerboseFlags, J9NLS_SHRC_SHRINIT_FIND_FAILED_VERBOSE_AOT_MSG, methodNameAndSignature);
		}
	}
 ...
 */
static IDATA
omrshr_aotMethodOperation(OMR_VM* vm, char* methodSpecs, UDATA action)
{
	IDATA rc = 0;
	OMR_VMThread* currentThread = omr_vmthread_getCurrent(vm);
...
adjustCacheSizes(OMRPortLibrary* portlib, UDATA verboseFlags, OMRSharedCachePreinitConfig* piconfig, U_64 newSize)
{
	...
	bool printMessage = OMR_ARE_ALL_BITS_SET(verboseFlags, OMRSHR_VERBOSEFLAG_ENABLE_VERBOSE);
	OMRPORT_ACCESS_FROM_OMRPORT(portlib);
 ...
 */
//void
//omrshr_jvmPhaseChange(OMR_VMThread *currentThread, UDATA phase)
//{
//	if (J9VM_PHASE_NOT_STARTUP == phase) {
//		OMR_VM* vm = currentThread->_vm;
//
//		if (OMR_ARE_NO_BITS_SET(vm->sharedClassConfig->runtimeFlags, OMRSHR_RUNTIMEFLAG_MPROTECT_PARTIAL_PAGES_ON_STARTUP)) {
 ...
 */
static IDATA
checkIfCacheExists(OMR_VM* vm, const char* ctrlDirName, char* cacheDirName, const char* cacheName, J9PortShcVersion* versionData, U_32 cacheType)
{
	IDATA ret = -1;
	OMRPORT_ACCESS_FROM_VMC(vm);

	if (-1 == SH_OSCache::getCacheDir(vm, ctrlDirName, cacheDirName, OMRSH_MAXPATH, cacheType)) {
 ...
 */
//static bool
//isClassFromPatchedModule(OMR_VMThread* vmThread, J9Module *j9module, U_8* className, UDATA classNameLength, J9ClassLoader* classLoader)
//{
//	bool ret = false;
//	J9Module *module = j9module;
//	OMR_VM* vm = vmThread->javaVM;
//	J9InternalVMFunctions const * const vmFuncs = vm->internalVMFunctions;
//
//	if (OMR_ARE_NO_BITS_SET(vm->jclFlags, J9_JCL_FLAG_JDK_MODULE_PATCH_PROP)) {
//		return ret;
//	}
//	
//	if (NULL != module) {
 ...
 */
//static J9Module*
//getModule(OMR_VMThread* vmThread, U_8* className, UDATA classNameLength, J9ClassLoader* classLoader)
//{
//	J9Module *module = NULL;
//	OMR_VM* vm = vmThread->javaVM;
//	J9InternalVMFunctions const * const vmFuncs = vm->internalVMFunctions;
//
//	if (OMR_ARE_NO_BITS_SET(vm->runtimeFlags, J9_RUNTIME_JAVA_BASE_MODULE_CREATED)) {
 ...
 */
static bool
isFreeDiskSpaceLow(OMR_VM *vm, U_64* maxsize)
{
	char cacheDirName[OMRSH_MAXPATH];
	memset(cacheDirName, 0, OMRSH_MAXPATH);
	bool ret = true;
	OMRPORT_ACCESS_FROM_VMC(vm);

	if (-1 == SH_OSCache::getCacheDir(vm, vm->sharedCacheAPI->ctrlDirName, cacheDirName, OMRSH_MAXPATH, OMRPORT_SHR_CACHE_TYPE_PERSISTENT)) {
		Trc_SHR_INIT_isFreeDiskSpaceLow_getDirFailed();
		goto done;
	}
	/* check for free disk space */
	J9FileStatFilesystem fileStatFilesystem;
	if (0 == omrfile_stat_filesystem(cacheDirName, 0, &fileStatFilesystem)) {
