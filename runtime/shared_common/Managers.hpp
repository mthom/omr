...
#include "Manager.hpp"
//#include "j9.h"
#include "omr.h" // omr.h takes the place of j9.h in OMR.
...
public:
	...
	public :
        ...
        static SH_Managers* newInstance(OMR_VM* vm, SH_Managers* memForConstructor);
	static UDATA getRequiredConstrBytes();

	SH_Manager* getManager(UDATA index);
	SH_Manager* addManager(SH_Manager* manager);
	SH_Manager* startDo(OMR_VMThread* vmthread, UDATA limitState, ManagerWalkState* walkState);
