...
{
public:
	virtual IDATA startupForStats(OMR_VMThread* currentThread, SH_OSCache * oscache, U_64 * runtimeflags) = 0;

	virtual IDATA shutdownForStats(OMR_VMThread* currentThread) = 0;
