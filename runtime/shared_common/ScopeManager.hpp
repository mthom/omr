...
public:
	...
	virtual const OMRUTF8* findScopeForUTF(OMR_VMThread* currentThread, const OMRUTF8* localScope) = 0;

	virtual IDATA validate(OMR_VMThread* currentThread, const OMRUTF8* partition, const OMRUTF8* modContext, const ShcItem* item) = 0;
};
