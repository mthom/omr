...
{
	public:
	virtual IDATA setRegionPermissions(OMRPortLibrary* portLibrary, void *address, UDATA length, UDATA flags) = 0;
	...
	virtual void changePartialPageProtection(OMR_VMThread *currentThread, void *addr, bool readOnly, bool phaseCheck = true) = 0;
};
