...
void
SH_OSCache::dontNeedMetadata(OMR_VMThread* currentThread, const void* startAddress, size_t length) {
	return;
}
 ...
 */
bool
SH_OSCache::getCacheStatsCommon(OMR_VM* vm, SH_OSCache *cache, SH_OSCache_Info *cacheInfo)
{
	bool retval = true;
