...
#if !defined(OS_SHARED_MEMORY_CACHE_ITERATOR_HPP_INCLUDED)
#define OS_SHARED_MEMORY_CACHE_ITERATOR_HPP_INCLUDED

#include "OSCacheIterator.hpp"

#include "omr.h"

class OSSharedMemoryCacheIterator: public OSCacheIterator
{
public:
