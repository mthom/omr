 ...
 * Use the OMRSHR_READMEM() helper below.
 */
#if defined(J9VM_OUT_OF_PROCESS) 
#define OMRSHR_READMEM(x_) dbgReadPrimitiveType((UDATA)&(x_), sizeof(x_))
#define OMRSHR_READSRP(x_) shcDbgReadSRP((UDATA)&(x_))
#else
#define OMRSHR_READMEM(x_) (x_)
#define OMRSHR_READSRP(x_) (x_)
#endif
...
#define CCITEMLEN(ih) (OMRSHR_READMEM((ih)->itemLen) & 0xFFFFFFFE)
#define CCITEMSTALE(ih) (OMRSHR_READMEM((ih)->itemLen) & 0x1)
...
#define ITEMEND(i) (((U_8*)(i)) + OMRSHR_READMEM((i)->dataLen))
#define ITEMJVMID(i) (OMRSHR_READMEM((i)->jvmID))
#define ITEMTYPE(i) (OMRSHR_READMEM((i)->dataType))
#define ITEMDATALEN(i) (OMRSHR_READMEM((i)->dataLen) - sizeof(ShcItem))
...
#define SHC_FINAL_ROMCLASS_U32(rc) (*((U_32*)(((U_8*)rc) + OMRSHR_READMEM((rc)->romSize)) - 1))
...
#define CPWLEN(cpw) (sizeof(ClasspathWrapper) + OMRSHR_READMEM((cpw)->ClasspathItemSize))
...
#define RCWROMCLASS(rcw) (((U_8*)(rcw)) + OMRSHR_READSRP((rcw)->romClassOffset))
#define RCWCLASSPATH(rcw) (((U_8*)(rcw)) + OMRSHR_READSRP((rcw)->theCpOffset))

/* These macros are only valid for a ScopedROMClassWrapper */
#define RCWMODCONTEXT(srcw) (OMRSHR_READSRP(srcw->modContextOffset) ? (((U_8*)(srcw)) + OMRSHR_READSRP((srcw)->modContextOffset)) : 0)
#define RCWPARTITION(srcw) (OMRSHR_READSRP(srcw->partitionOffset) ? (((U_8*)(srcw)) + OMRSHR_READSRP((srcw)->partitionOffset)) : 0)

typedef struct OrphanWrapper {
	J9SRP romClassOffset;
} OrphanWrapper;

#define OWROMCLASS(ow) (((U_8*)(ow)) + OMRSHR_READSRP((ow)->romClassOffset))
...
#define CMWROMMETHOD(cmw) (((U_8*)(cmw)) + OMRSHR_READSRP((cmw)->romMethodOffset))
#define CMWDATA(cmw) (((U_8*)(cmw)) + sizeof(CompiledMethodWrapper))
#define CMWCODE(cmw) (((U_8*)(cmw)) + sizeof(CompiledMethodWrapper) + OMRSHR_READMEM((cmw)->dataLength))
...
#define CAWROMSTRING(caw) (((U_8*)(caw)) + OMRSHR_READSRP((caw)->romStringOffset))
...
#define BDWTOKEN(bdw) (OMRSHR_READSRP((bdw)->tokenOffset) ? (((U_8*)(bdw)) + OMRSHR_READSRP((bdw)->tokenOffset)) : NULL)
#define BDWDATA(bdw) (OMRSHR_READSRP((bdw)->externalBlockOffset) ? (((U_8*)(bdw)) + OMRSHR_READSRP((bdw)->externalBlockOffset)) : (((U_8*)(bdw)) + sizeof(ByteDataWrapper)))
#define BDWITEM(bdw) (((U_8*)(bdw)) - sizeof(ShcItem))
#define BDWLEN(bdw) OMRSHR_READMEM((bdw)->dataLength)
#define BDWTYPE(bdw)  OMRSHR_READMEM((bdw)->dataType)
#define BDWEXTBLOCK(bdw) OMRSHR_READMEM((bdw)->externalBlockOffset)
#define BDWINPRIVATEUSE(bdw) OMRSHR_READMEM((bdw)->inPrivateUse)
#define BDWPRIVATEOWNERID(bdw) OMRSHR_READMEM((bdw)->privateOwnerID)
...
#define CLETDATA(clet) (((U_8*)(clet)) + OMRSHR_READSRP((clet)->dataStart))
...
#define ADWCACHEOFFSET(adw) (((U_8*)(adw)) + OMRSHR_READSRP((adw)->cacheOffset))
#define ADWLEN(adw) OMRSHR_READMEM((adw)->dataLength)
#define ADWTYPE(adw) OMRSHR_READMEM((adw)->type)
#define ADWCORRUPT(adw) OMRSHR_READMEM((adw)->corrupt)
#define ADWUPDATECOUNT(adw) OMRSHR_READMEM((adw)->updateCount)
