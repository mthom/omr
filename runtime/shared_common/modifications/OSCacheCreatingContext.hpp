...
#if !defined(OSCACHE_CREATING_CONTEXT_HPP_INCLUDED)
#define OSCACHE_CREATING_CONTEXT_HPP_INCLUDED

#include "omr.h"

class OSCacheCreatingContext
{
public:
  // the previous comment spec, from CompositeCacheImpl:
  ...
  virtual void setCacheAreaBoundaries() = 0;
};
