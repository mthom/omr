 ...
 * 				area of a new cache
 */
SH_OSCachesysv::SH_OSCachesysv(OMRPortLibrary* portLibrary, J9JavaVM* vm, const char* cachedirname, const char* cacheName, J9SharedClassPreinitConfig* piconfig, IDATA numLocks,
