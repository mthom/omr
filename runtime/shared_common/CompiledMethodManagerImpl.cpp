...
SH_CompiledMethodManagerImpl::newInstance(OMR_VM* vm, SH_SharedCache* cache_, SH_CompiledMethodManagerImpl* memForConstructor)
{
...
void
SH_CompiledMethodManagerImpl::initialize(OMR_VM* vm, SH_SharedCache* cache_, BlockPtr memForConstructor)
{
