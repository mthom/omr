...
// #include "j9protos.h"
#include "ut_omrshr.h"
#include "shcflags.h" // used to be included through j9.h
...
public:
  ...
  //	virtual U_32 getDebugBytes(void) = 0;
	...
	virtual IDATA restoreFromSnapshot(OMR_VM* vm, const char* cacheName, bool* cacheExist) = 0;

	virtual I_32 tryAdjustMinMaxSizes(OMR_VMThread *currentThread, bool isJCLCall = false) = 0;
};
