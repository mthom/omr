#ifndef OMR_SYMBOLVALIDATIONMANAGER_INCL
#define OMR_SYMBOLVALIDATIONMANAGER_INCL
...
#define SVM_ASSERT_IMPL(assertName, nonfatal, condition, condStr, format, ...)                  \
   do                                                                                           \
      ...
      if (!(condition))                                                                         \
         {                                                                                      \
         if (!(nonfatal) && ::OMR::SymbolValidationManager::assertionsAreFatal())                \
...
namespace TR { struct SymbolValidationRecord; }
namespace TR { struct LessSymbolValidationRecord; }
namespace TR { struct ClassValidationRecord; }
namespace TR { struct ClassValidationRecordWithChain; }
namespace TR { struct ClassByNameRecord; }
namespace TR { struct ProfiledClassRecord; }
namespace TR { struct ClassFromCPRecord; }
namespace TR { struct StaticClassFromCPRecord; }
namespace TR { struct ArrayClassFromComponentClassRecord; }
namespace TR { struct SuperClassFromClassRecord; }
namespace TR { struct ClassInstanceOfClassRecord; }
namespace TR { struct SystemClassByNameRecord; }
namespace TR { struct ClassFromITableIndexCPRecord; }
namespace TR { struct DeclaringClassFromFieldOrStaticRecord; }
namespace TR { struct ClassChainRecord; }
namespace TR { struct ConcreteSubClassFromClassRecord; }
namespace TR { struct MethodValidationRecord; }
namespace TR { struct MethodFromClassRecord; }
namespace TR { struct StaticMethodFromCPRecord; }
namespace TR { struct SpecialMethodFromCPRecord; }
namespace TR { struct VirtualMethodFromOffsetRecord; }
namespace TR { struct InterfaceMethodFromCPRecord; }
namespace TR { struct VirtualMethodFromCPRecord; }
namespace TR { struct MethodFromClassAndSigRecord; }
namespace TR { struct StackWalkerMaySkipFramesRecord; }
namespace TR { struct ClassInfoIsInitialized; }
namespace TR { struct MethodFromSingleImplementer; }
namespace TR { struct MethodFromSingleInterfaceImplementer; }
namespace TR { struct MethodFromSingleAbstractImplementer; }
namespace TR { struct ImproperInterfaceMethodFromCPRecord; }
namespace OMR { class SymbolValidationManager; }
namespace OMR { typedef SymbolValidationManager SymbolValidationManagerConnector; }
...
class OMR_EXTENSIBLE SymbolValidationManager
   {
public:
...
// bool validateMethodFromClassAndSignatureRecord(uint16_t methodID, uint16_t definingClassID, uint16_t lookupClassID, uint16_t beholderID, J9ROMMethod *romMethod);
   ...
   typedef TR::list<TR::SymbolValidationRecord *, TR::Region&> SymbolValidationRecordList;
...
// bool validateSymbol(uint16_t methodID, uint16_t definingClassID, J9Method *method);
   ...
   OMR_VMThread * const _vmThread;
   OMR_VM * const _fej9; // DEFAULT_VM
...
// TR_PersistentCHTable * const _chTable;
   ...
   typedef TR::typed_allocator<TR::SymbolValidationRecord*, TR::Region&> RecordPtrAlloc;
   typedef std::set<TR::SymbolValidationRecord*, TR::LessSymbolValidationRecord, RecordPtrAlloc> RecordSet;
...
#endif OMR_SYMBOLVALIDATIONMANAGER_INCL
