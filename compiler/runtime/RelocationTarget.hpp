...
class RelocationTarget
   ...
   public:
      ...
      virtual bool isOrderedPairRelocation(RelocationRecord *reloRecord, RelocationTarget *reloTarget);
     ...
     // virtual void patchMTIsolatedOffset(uint32_t offset, uint8_t *reloLocation);
       ...
       */
      void addPICtoPatchPtrOnClassUnload(OpaqueClassBlock *classKey, void *ptr);
   private:
      virtual void platformAddPICtoPatchPtrOnClassUnload(OpaqueClassBlock *classKey, void *ptr);
