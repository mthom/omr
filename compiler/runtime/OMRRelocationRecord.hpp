...
struct OMR_RelocationRecordBinaryTemplate
   {
...
class TR_RelocationRecordGroup
   ...
   public:
      ...
      TR_RelocationRecordBinaryTemplate *firstRecord(TR::RelocationTarget *reloTarget);
      TR_RelocationRecordBinaryTemplate *pastLastRecord(TR::RelocationTarget *reloTarget);

      int32_t applyRelocations(TR_RelocationRuntime *reloRuntime,
                               TR::RelocationTarget *reloTarget,
                               uint8_t *reloOrigin);
   private:
      int32_t handleRelocation(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, TR_RelocationRecord *reloRecord, uint8_t *reloOrigin);
...
class OMR_RelocationRecord
   {
   public:
      OMR_RelocationRecord() {}
      OMR_RelocationRecord(TR_RelocationRuntime *reloRuntime, TR_RelocationRecordBinaryTemplate *record)
      ...
      static TR_RelocationRecord *create(TR_RelocationRecord *storage, TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, TR_RelocationRecordBinaryTemplate *recordPointer);

      virtual void clean(TR::RelocationTarget *reloTarget);
      virtual int32_t bytesInHeaderAndPayload();

      virtual void preparePrivateData(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget);

      virtual int32_t applyRelocationAtAllOffsets(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *relocationOrigin);

      virtual int32_t applyRelocation(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocation) {return -1;}
      virtual int32_t applyRelocation(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocationHigh, uint8_t *reloLocationLow) {return -1;}

      TR_RelocationRecordBinaryTemplate *nextBinaryRecord(TR::RelocationTarget *reloTarget);
      ...
      TR_RelocationRecordType type(TR::RelocationTarget *reloTarget);
   ...
   protected:
      ...
      uint8_t *computeHelperAddress(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *baseLocation);
...
class TR_RelocationRecordBodyInfo : public TR_RelocationRecord
   ...
   public:
      ...
      virtual int32_t applyRelocation(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocation);
   };
...
class TR_RelocationRecordWithOffset : public TR_RelocationRecord
   ...
   public:
      ...
      virtual void preparePrivateData(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget);
      virtual int32_t applyRelocation(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocation);
      virtual int32_t applyRelocation(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocationHigh, uint8_t *reloLocationLow);
   };
...
class TR_RelocationRecordWithInlinedSiteIndex : public TR_RelocationRecord
   ...
   public:
      ...
      void setInlinedSiteIndex(TR::RelocationTarget *reloTarget, uintptr_t inlinedSiteIndex);
      uintptr_t inlinedSiteIndex(TR::RelocationTarget *reloTarget);
...
class TR_RelocationRecordConstantPool : public TR_RelocationRecordWithInlinedSiteIndex
   ...
   public:
      ...
      void setConstantPool(TR::RelocationTarget *reloTarget, uintptrj_t constantPool);
      uintptrj_t constantPool(TR::RelocationTarget *reloTarget);
   ...
   protected:
      uintptrj_t currentConstantPool(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uintptrj_t oldValue);
      uintptrj_t findConstantPool(TR::RelocationTarget *reloTarget, uintptrj_t oldValue, TR_OpaqueMethodBlock *ramMethod);
      uintptrj_t computeNewConstantPool(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uintptrj_t oldValue);
   };
...
class TR_RelocationRecordConstantPoolWithIndex : public TR_RelocationRecordConstantPool
   ...
   public:
      ...
      void setCpIndex(TR::RelocationTarget *reloTarget, uintptrj_t cpIndex);
      uintptrj_t cpIndex(TR::RelocationTarget *reloTarget);
...
class TR_RelocationRecordHelperAddress : public TR_RelocationRecord
   ...
   public:
      ...
      void setHelperID(TR::RelocationTarget *reloTarget, uint32_t helperID);
      uint32_t helperID(TR::RelocationTarget *reloTarget);
...
class TR_RelocationRecordDataAddress : public TR_RelocationRecordConstantPoolWithIndex
   ...
   public:
      ...
      uint8_t *findDataAddress(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget);
...
class TR_RelocationRecordThunks : public TR_RelocationRecordConstantPool
   ...
   protected:
      int32_t relocateAndRegisterThunk(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uintptrj_t cp, uintptr_t cpIndex, uint8_t *reloLocation);

      /** Relocate the J2I virtual thunk pointer, if applicable */
      virtual void relocateJ2IVirtualThunkPointer(TR::RelocationTarget *reloTarget, uint8_t *reloLocation, void *thunk)
         {
         // nothing to relocate
         }
   };
...
class TR_RelocationRecordJ2IVirtualThunkPointer : public TR_RelocationRecordThunks
   ...
   protected:
      virtual void relocateJ2IVirtualThunkPointer(TR::RelocationTarget *reloTarget, uint8_t *reloLocation, void *thunk);
      uintptrj_t offsetToJ2IVirtualThunkPointer(TR::RelocationTarget *reloTarget);
   };
...
class TR_RelocationRecordPicTrampolines : public TR_RelocationRecord
   ...
   public:
      ...
      void setNumTrampolines(TR::RelocationTarget *reloTarget, int numTrampolines);
      uint8_t numTrampolines(TR::RelocationTarget *reloTarget);
...
class TR_RelocationRecordInlinedAllocation : public TR_RelocationRecordConstantPoolWithIndex
   ...
   public:
      ...
      void setBranchOffset(TR::RelocationTarget *reloTarget, uintptr_t branchOffset);
      uintptr_t branchOffset(TR::RelocationTarget *reloTarget);

      virtual int32_t applyRelocation(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocation);
   protected:

      virtual void preparePrivateData(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget);
      virtual bool verifyClass(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, TR_OpaqueClassBlock *clazz);
   };
...
class TR_RelocationRecordVerifyClassObjectForAlloc : public TR_RelocationRecordInlinedAllocation
   ...
   public:
      ...
      void setAllocationSize(TR::RelocationTarget *reloTarget, uintptr_t allocationSize);
      uintptr_t allocationSize(TR::RelocationTarget *reloTarget);
...
class TR_RelocationRecordInlinedMethod : public TR_RelocationRecordConstantPoolWithIndex
   ...
   public:
      ...
      void setRomClassOffsetInSharedCache(TR::RelocationTarget *reloTarget, uintptrj_t romClassOffsetInSharedCache);
      uintptrj_t romClassOffsetInSharedCache(TR::RelocationTarget *reloTarget);
   ...
   protected:
      virtual void fixInlinedSiteInfo(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, TR_OpaqueMethodBlock *inlinedMethod);

   private:
      virtual bool inlinedSiteValid(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, TR_OpaqueMethodBlock **theMethod);
      ...
      virtual void invalidateGuard(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocation) {};
      virtual void activateGuard(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocation) {};
...
class TR_RelocationRecordNopGuard : public TR_RelocationRecordInlinedMethod
   ...
   public:
      ...
      void setDestinationAddress(TR::RelocationTarget *reloTarget, uintptrj_t destinationAddress);
      uintptrj_t destinationAddress(TR::RelocationTarget *reloTarget);
...
class TR_RelocationRecordProfiledInlinedMethod : public TR_RelocationRecordInlinedMethod
   ...
   public:
      ...
      void setClassChainIdentifyingLoaderOffsetInSharedCache(TR::RelocationTarget *reloTarget, uintptrj_t classChainOffsetInSharedCache);
      uintptrj_t classChainIdentifyingLoaderOffsetInSharedCache(TR::RelocationTarget *reloTarget);

      void setClassChainForInlinedMethod(TR::RelocationTarget *reloTarget, uintptrj_t classChainForInlinedMethod);
      uintptrj_t classChainForInlinedMethod(TR::RelocationTarget *reloTarget);

      void setVTableSlot(TR::RelocationTarget *reloTarget, uintptrj_t vTableSlot);
      uintptrj_t vTableSlot(TR::RelocationTarget *reloTarget);

      virtual void preparePrivateData(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget);

   private:
      virtual void setupInlinedMethodData(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget);
...
class TR_RelocationRecordValidateClass : public TR_RelocationRecordConstantPoolWithIndex
   ...
   public:
      ...
      void setClassChainOffsetInSharedCache(TR::RelocationTarget *reloTarget, uintptrj_t classChainOffsetInSharedCache);
      uintptrj_t classChainOffsetInSharedCache(TR::RelocationTarget *reloTarget);

      virtual int32_t applyRelocation(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocation);
      virtual void preparePrivateData(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget);

   protected:
      virtual TR_OpaqueClassBlock *getClassFromCP(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, void *void_cp);
...
class TR_RelocationRecordValidateStaticField : public TR_RelocationRecordValidateInstanceField
   ...
   protected:
      virtual TR_OpaqueClassBlock *getClass(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, void *void_cp);
      virtual bool validateClass(TR_RelocationRuntime *reloRuntime, TR_OpaqueClassBlock *clazz, void *classChainOrRomClass);
   };
...
class TR_RelocationRecordValidateArbitraryClass : public TR_RelocationRecord
   ...
   public:
      ...
      void setClassChainIdentifyingLoaderOffset(TR::RelocationTarget *reloTarget, uintptrj_t classChainOffset);
      uintptrj_t classChainIdentifyingLoaderOffset(TR::RelocationTarget *reloTarget);

      void setClassChainOffsetForClassBeingValidated(TR::RelocationTarget *reloTarget, uintptrj_t classChainOffset);
      uintptrj_t classChainOffsetForClassBeingValidated(TR::RelocationTarget *reloTarget);
...
class TR_RelocationRecordSymbolFromManager : public TR_RelocationRecord
   ...
   public:
      ...
      virtual void preparePrivateData(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget);
      virtual int32_t applyRelocation(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocation);
      virtual void activatePointer(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocation);
...
class TR_RelocationRecordPointer : public TR_RelocationRecordWithInlinedSiteIndex
   ...
   public:
      ...
      void setClassChainForInlinedMethod(TR::RelocationTarget *reloTarget, uintptrj_t classChainOffsetInSharedCache);
      uintptrj_t classChainForInlinedMethod(TR::RelocationTarget *reloTarget);
      ...
      virtual int32_t applyRelocation(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocation);
   protected:
      virtual uintptrj_t computePointer(TR::RelocationTarget *reloTarget, TR_OpaqueClassBlock *classPointer) { return 0;}
      virtual void activatePointer(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocation);
...
class TR_RelocationRecordClassPointer : public TR_RelocationRecordPointer
   ...
   protected:
      virtual uintptrj_t computePointer(TR::RelocationTarget *reloTarget, TR_OpaqueClassBlock *classPointer);
      virtual void activatePointer(TR_RelocationRuntime *reloRuntime, TR::RelocationTarget *reloTarget, uint8_t *reloLocation);
   };
