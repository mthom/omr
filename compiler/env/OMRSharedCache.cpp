...
#include "env/OMRSharedCache.hpp"
...
#include "env/VMAccessCriticalSection.hpp" // this exists, and is important! So vitally important!
// #include "runtime/CodeRuntime.hpp" // buh, I don't know what this is in J9.
// #include "control/CompilationRuntime.hpp" // also doesn't appear to exist in OMR.
// #include "env/VMJ9.h" // same with these.
...
OMRSharedCache::OMRSharedCache()//TR_J9VMBase *fe)
   {
     // _fe = fe;
   ...
   _cacheStartAddress = (UDATA) _cacheDescriptorList->cacheStartAddress;
   _cacheSizeInBytes = _cacheDescriptorList->cacheSizeBytes;
