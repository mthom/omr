...
class OMR_EXTENSIBLE CodeGenerator
   ...
   void addASHLExternalRelocation(const char *generatingFileName, uintptr_t generatingLineNumber, TR::Node *node, void* data, uint8_t* size, TR_ExternalRelocationTargetKind kind, uint8_t* cursor);
