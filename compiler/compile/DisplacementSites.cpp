...
TR_DisplacementSite::TR_DisplacementSite(uint64_t assumptionID)
  : _sites(getTypedAllocator<uint8_t*, TRPersistentMemoryAllocator>(TRPersistentMemoryAllocator(trPersistentMemory))),
    _assumptionID(assumptionID), _nodeAddress(0),
    _dispSize(TR_DisplacementSite::bits_32){}
